...
| Module | Key Classes | Purpose |
|--------|-------------|---------|
| `scripts/testbot/` | `LLMProvider`, `TestbotState`, `LLMClient` | AI-powered coverage gap analysis, test generation, and PR creation. Plugin architecture for LLM providers (Nemotron/NIM, Claude Code, OpenAI). |
