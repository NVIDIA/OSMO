...
| Module | Key Classes | Purpose |
|--------|-------------|---------|
| `scripts/testbot/` | `LLMProvider`, `TestbotState`, `LangGraph` | AI-powered coverage gap analysis, test generation, and PR creation. Plugin architecture for LLM providers (Nemotron/NIM, Claude Code, OpenAI). |
