...
any deliberately permissive development identity. The Azure deployment example
does so only for its locally port-forwarded ClusterIP gateway. External identity
...
[`deploy-osmo-single-plane.sh`](../../scripts/deploy-osmo-single-plane.sh):
