...
# Fields that should not be emitted directly into Helm values.
# service_auth contains private signing keys; provide it through
# services.configs.serviceAuthSecretName or a manually managed Secret.
