...
OSMO uses `KAI scheduler <https://github.com/NVIDIA/kai-scheduler>`_ to run AI workflows at very large scale with `Workflow Groups <http://nvidia.github.io/OSMO/user_guide/tutorials/parallel_workflows/index.html#groups>`_.
