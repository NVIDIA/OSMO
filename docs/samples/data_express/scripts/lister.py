...
import osmo.data
from osmo.utils import s3, storage_backends
...
def chunk_files(input_location: str, output_location: str, chunk_size: float, chunk_amount: int,
    ...
    if data_utils.is_remote_path(input_location):
        ...
        for file in osmo.data.list_files(input_location, regex=regex):
        ...
        for file in osmo.data.list_local_files_for_upload(input_location, output_location,
                                                          regex=regex):
