...
class Trainer:
    ...
    def _run_epoch(self, epoch):
        ...
        print(f"[GPU_{self.global_rank}] Epoch {epoch} | Batchsize: {b_sz} | Steps: {len(self.train_data)}")
...
def main(args: argparse.Namespace):
    ...
    # Train
    trainer = Trainer(model, train_data, optimizer, args.snapshot_path)
    try:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--error_log', default='/tmp/training_errors.log',
                        help='Path to save error logs')
