...
Collections can be created with the :ref:`ds_collection` CLI and use the most of the same CLIs as
datasets. To learn more about CLIs that are exclusive to datasets, see :ref:`faqs`. You cannot
upload, tag, or add metadata to a collection.
