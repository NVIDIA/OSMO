...
When a workflow fails, refer to :ref:`wf_query` to gain an overview of the workflow tasks
...
Use :ref:`wf_logs` for a better insight of what happened during the workflow runtime.
