...
.. code-block:: text
   ...
   osmo workflow events [-h] [--task TASK] [--retry-id RETRY_ID] workflow_id
...
.. code-block:: text
   ...
   osmo workflow list [-h] [--count COUNT] [--offset OFFSET] [--name NAME]
                      [--order {asc,desc}] [--status STATUS [STATUS ...]]
                      [--format-type {json,text}]
...
.. code-block:: text
   ...
   osmo workflow exec [-h] [--entry EXEC_ENTRY_COMMAND]
                      [--connect-timeout CONNECT_TIMEOUT] [--keep-alive]
                      workflow_id (--group GROUP | task)
...
.. code-block:: text
   ...
   osmo workflow rsync [-h] {upload,download,status,stop} ...
...
.. code-block:: text
   ...
   osmo workflow rsync upload [-h] [--timeout TIMEOUT]
...
.. code-block:: text
   ...
   osmo workflow rsync download [-h] [--timeout TIMEOUT] [--no-progress]
                                workflow_id [task] [path]
...
.. code-block:: text
   ...
   osmo workflow rsync stop [-h] [--task TASK] [workflow_id]
