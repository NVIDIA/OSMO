...
Now that you have authenticated with the OSMO CLI, you can submit a workflow.
...
* See additional tutorials with more advanced use cases: :ref:`Tutorials <osmo_in_20>`
