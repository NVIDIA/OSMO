...
for example, using `train.py <https://github.com/NVIDIA/OSMO/blob/main/cookbook/dnn_training/torchrun_multinode/train.py>`_.
...
You can use the a barrier script like `osmo_barrier.py <https://github.com/NVIDIA/OSMO/blob/main/cookbook/dnn_training/torchrun_multinode/osmo_barrier.py>`_ to synchronize before the training launches.
