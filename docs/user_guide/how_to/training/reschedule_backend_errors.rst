...
In the workflow spec, you can load and checkpoint the snapshots with :ref:`checkpointing <workflow_spec_checkpointing>`.
...
See more about ``ignoreNonleadStatus`` in :ref:`workflow_spec_group` and actions on exit codes in :ref:`workflow_spec_exit_actions`.
