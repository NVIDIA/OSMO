...
Let's build a **three-stage** serial workflow (:download:`serial_workflow.yaml <../../../../cookbook/tutorials/serial_workflow.yaml>`):
...
.. literalinclude:: ../../../../cookbook/tutorials/serial_workflow.yaml
  :language: yaml
