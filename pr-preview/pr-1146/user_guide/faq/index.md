...
For a practical example of rescheduling training workflows for backend errors, see [here](https://github.com/NVIDIA/OSMO/tree/release/6.1/workflows/dnn_training/torchrun_reschedule).
...
For a complete guide with examples, see the [NIM workflow example](https://github.com/NVIDIA/OSMO/tree/release/6.1/workflows/nims).
