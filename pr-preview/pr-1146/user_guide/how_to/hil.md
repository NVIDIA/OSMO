...
The complete workflow file and required scripts can be found on [Github](https://github.com/NVIDIA/OSMO/tree/release/6.1/workflows/hil).

## Interfacing with Simulation Window

For a refresher on connecting to the Isaac Sim Streaming Client, see the [Livestream tutorial](https://github.com/NVIDIA/OSMO/tree/release/6.1/workflows/integration_and_tools/isaacsim).
