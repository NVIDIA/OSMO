...
<a id="guides-reinforcement-learning"></a>
...
using [Isaac Lab](https://developer.nvidia.com/isaac/lab), NVIDIA’s framework for robot learning.
...
The complete workflow example is available [here](https://github.com/NVIDIA/OSMO/tree/release/6.1/workflows/reinforcement_learning).
...
We will reference the commands in the Isaac Lab reinforcement learning [example for Stable Baselines 3](https://isaac-sim.github.io/IsaacLab/main/source/overview/reinforcement-learning/rl_existing_scripts.html#stable-baselines3).
...
The complete workflow spec file is available as [train_policy.yaml](https://github.com/NVIDIA/OSMO/blob/release/6.1/workflows/reinforcement_learning/single_gpu/train_policy.yaml).
...
![image](user_guide/how_to/images/tensorboard_reinforcement_learning.png)
...
![image](user_guide/how_to/images/rl-video-step-0.gif)
...
![image](user_guide/how_to/images/rl-franka-video-step-0.gif)
