...
The complete workflow example is available [here](https://github.com/NVIDIA/OSMO/tree/release/6.1/workflows/dnn_training/single_node).

## Launching a Training Script in a Workflow

Suppose you have a training script [train.py](https://github.com/NVIDIA/OSMO/blob/release/6.1/workflows/dnn_training/single_node/train.py) ready to use.
...
> **Note**
>
> Refer to [Data](../../getting_started/credentials.md#credentials-data) to create a data credential to manage your datasets.
...
If you want to use [Weights and Biases](https://wandb.ai/) to manage your training process,
...
![image](user_guide/how_to/images/tensorboard.png)
