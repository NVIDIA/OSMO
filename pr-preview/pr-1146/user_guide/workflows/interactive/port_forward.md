...
<a id="workflow-interactive-port-forward"></a>
...
[Jupyter Notebook](https://github.com/NVIDIA/OSMO/tree/release/6.1/workflows/integration_and_tools/jupyterlab),
a [VSCode Server](https://github.com/NVIDIA/OSMO/tree/release/6.1/workflows/integration_and_tools/vscode)
or a [Ray dashboard](https://github.com/NVIDIA/OSMO/tree/release/6.1/workflows/integration_and_tools/ray) .
...
![Browser Port-Forward](user_guide/workflows/interactive/port_forward.gif)
