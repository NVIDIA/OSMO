...
<a id="workflow-spec-inputs-and-outputs"></a>

# Inputs and Outputs

<a id="workflow-spec-inputs"></a>
...
* `dataset`: Downloads the files from a dataset. Learn more about datasets at [Working with Data](../../tutorials/data/index.md#tutorials-working-with-data-datasets).

> **Note**
>
> `dataset` can also be used to download the user’s local files/directories with the `localpath`
> attribute. For more information, see [File Injection](file_injection.md#workflow-spec-file-injection).
...
These inputs can be referenced in the task using [Special Tokens](templates_and_tokens.md#workflow-spec-special-tokens).
...
| regex       | A regex to filter the files to download.                                                                                                                                                                                             |
| localpath   | When this is specified, this path is taken from the user’s local machine and uploaded as<br/>a dataset to be downloaded in the task. Learn more about localpath at [File Injection](file_injection.md#workflow-spec-file-injection). |
...
On how to specify which files to be uploaded, go to [Templates and Special Tokens](templates_and_tokens.md#workflow-spec-templates-and-special-tokens).
