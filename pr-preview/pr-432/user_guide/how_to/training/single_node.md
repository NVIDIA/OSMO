...
The complete workflow example is available [here](https://github.com/NVIDIA/OSMO/tree/main/cookbook/dnn_training/single_node).

## Launching a Training Script in a Workflow

Suppose you have a training script [train.py](https://github.com/NVIDIA/OSMO/blob/main/workflows/dnn_training/single_node/train.py) ready to use.
