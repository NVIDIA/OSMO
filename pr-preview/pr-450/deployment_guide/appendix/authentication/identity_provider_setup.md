...
If you are evaluating OSMO or running in an environment without an IdP, use the **default admin** and **access tokens** instead (see [Default admin (no IdP)](index.md#default-admin-setup)).
...
#### SEE ALSO
- [Authentication and Authorization](index.md) for overview of authentication with and without an IdP
- [Authentication Flow](authentication_flow.md) for request flow
