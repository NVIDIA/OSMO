...
|-----------------|--------------------|---------------------|-------------------------------------------------------------------------|
| `ignore`        | (any)              | (any)               | No action. Role is never modified by IdP sync; manage it only via APIs. |
...
#### SEE ALSO
- [Authentication and Authorization](index.md) for authentication overview with and without an IdP
- [Roles and Policies](roles_policies.md) for role and policy definitions
- [Identity Provider (IdP) Setup](identity_provider_setup.md) for IdP configuration
