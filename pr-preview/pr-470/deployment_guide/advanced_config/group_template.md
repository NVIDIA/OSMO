...
> **Note**
>
> For detailed configuration fields and all available variables, see [/api/configs/group_template](../references/configs_definitions/group_template.md#group-template-config) in the API reference.
