...
| `common_group_templates`      | Array[String]                         | List of group template names applied to all task groups in the pool. These Kubernetes resources are created before the group’s pods. Read more about group templates in [Group Templates](../../advanced_config/group_template.md#group-template). | `[]`                                                   |
