...
def main():
    ...
    parser.add_argument("--coverage-source", default="codecov",
                        choices=["local", "codecov"],
                        help="Where to get coverage data (local LCOV files or Codecov API)")
    parser.add_argument("--codecov-token", default=os.getenv("CODECOV_TOKEN", ""),
