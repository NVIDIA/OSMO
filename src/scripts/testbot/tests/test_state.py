...
class TestTestTarget(unittest.TestCase):
    """Tests for TestTarget data class construction and fields."""
...
class TestTestbotState(unittest.TestCase):
    """Tests for TestbotState TypedDict construction and field access."""
    ...
    def test_coverage_state_construction(self):
        state: TestbotState = {
            ...
            "pr_url": None,
            "branch_name": "testbot/20260324",
            "dry_run": False,
            "ui_lcov_path": "src/ui/coverage/lcov.info",
            "coverage_source": "codecov",
            "codecov_token": "",
            "errors": [],
        }
