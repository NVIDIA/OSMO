...
MESSAGE_TOO_BIG_FAILURE = 'Disconnected because message is too big, set as FAILED_NO_RETRY'
INCOMPLETE_JOB_FAILURE = \
    'Agent worker stopped before current job completed, set as FAILED_NO_RETRY'
