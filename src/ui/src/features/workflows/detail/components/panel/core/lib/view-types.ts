 ...
 * Shared View Types
 *
 * Common prop types for workflow detail views and shared interfaces.
...
import type { WorkflowTab, TaskTab, GroupTab } from "@/features/workflows/detail/hooks/use-navigation-state";
