 ...
 */
export type ConfigHistoryType = typeof ConfigHistoryType[keyof typeof ConfigHistoryType];


export const ConfigHistoryType = {
  DATASET: 'DATASET',
  SERVICE: 'SERVICE',
  WORKFLOW: 'WORKFLOW',
  BACKEND: 'BACKEND',
 ...
 */
export type UserDataCredentialAddressingStyle = typeof UserDataCredentialAddressingStyle[keyof typeof UserDataCredentialAddressingStyle] | null;


export const UserDataCredentialAddressingStyle = {
  virtual: 'virtual',
  path: 'path',
  auto: 'auto',
} as const;
...
export interface UserDataCredential {
  ...
  /** S3 request addressing style for S3-compatible providers. Use 'virtual' for providers such as CoreWeave CAIOS that reject path-style requests, or 'path' for localstack/MinIO-style endpoints. */
  addressing_style?: UserDataCredentialAddressingStyle;
 ...
 * S3 request addressing style for S3-compatible providers. Use 'virtual' for providers such as CoreWeave CAIOS that reject path-style requests, or 'path' for localstack/MinIO-style endpoints.
 */
export type StaticDataCredentialAddressingStyle = typeof StaticDataCredentialAddressingStyle[keyof typeof StaticDataCredentialAddressingStyle] | null;


export const StaticDataCredentialAddressingStyle = {
  virtual: 'virtual',
  path: 'path',
  auto: 'auto',
} as const;
...
export interface StaticDataCredential {
  ...
  override_url?: string | null;
  /** S3 request addressing style for S3-compatible providers. Use 'virtual' for providers such as CoreWeave CAIOS that reject path-style requests, or 'path' for localstack/MinIO-style endpoints. */
  addressing_style?: StaticDataCredentialAddressingStyle;
  /** The authentication key for a data backend */
  access_key_id: string;
 ...
 * S3 request addressing style for S3-compatible providers. Use 'virtual' for providers such as CoreWeave CAIOS that reject path-style requests, or 'path' for localstack/MinIO-style endpoints.
 */
export type DefaultDataCredentialAddressingStyle = typeof DefaultDataCredentialAddressingStyle[keyof typeof DefaultDataCredentialAddressingStyle] | null;


export const DefaultDataCredentialAddressingStyle = {
  virtual: 'virtual',
  path: 'path',
  auto: 'auto',
} as const;
...
export interface DefaultDataCredential {
  ...
  override_url?: string | null;
  /** S3 request addressing style for S3-compatible providers. Use 'virtual' for providers such as CoreWeave CAIOS that reject path-style requests, or 'path' for localstack/MinIO-style endpoints. */
  addressing_style?: DefaultDataCredentialAddressingStyle;
}
 ...
 */
export type OperableConfigHistoryType = typeof OperableConfigHistoryType[keyof typeof OperableConfigHistoryType];


export const OperableConfigHistoryType = {
  SERVICE: 'SERVICE',
  WORKFLOW: 'WORKFLOW',
  BACKEND: 'BACKEND',
  POOL: 'POOL',
...
export interface WorkflowConfigInput {
  ...
  labels_config?: LabelsConfigInput;
...
export interface RollbackConfigRequest {
  description?: string | null;
  tags?: string[] | null;
  config_type: OperableConfigHistoryType;
  /**
...
export interface WorkflowConfigOutput {
  ...
  labels_config?: LabelsConfigOutput;
  max_num_tasks?: number;
  max_num_ports_per_task?: number;
  max_retry_per_task?: number;
  max_retry_per_job?: number;
 ...
 */
config_types?: ConfigHistoryType[] | null;
/**
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetBackendApiConfigsBackendNameGetQueryKey(name);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getBackendApiConfigsBackendNameGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getReadPoolApiConfigsPoolNameGetQueryKey(name,params);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof readPoolApiConfigsPoolNameGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListPlatformsInPoolApiConfigsPoolNamePlatformGetQueryKey(name,params);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listPlatformsInPoolApiConfigsPoolNamePlatformGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getReadPlatformInPoolApiConfigsPoolNamePlatformPlatformNameGetQueryKey(name,platformName,params);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined && platformName !== null && platformName !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof readPlatformInPoolApiConfigsPoolNamePlatformPlatformNameGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getReadPodTemplateApiConfigsPodTemplateNameGetQueryKey(name);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof readPodTemplateApiConfigsPodTemplateNameGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getReadGroupTemplateApiConfigsGroupTemplateNameGetQueryKey(name);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof readGroupTemplateApiConfigsGroupTemplateNameGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getReadResourceValidationApiConfigsResourceValidationNameGetQueryKey(name);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof readResourceValidationApiConfigsResourceValidationNameGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getReadRoleApiConfigsRoleNameGetQueryKey(name);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof readRoleApiConfigsRoleNameGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getReadBackendTestApiConfigsBackendTestNameGetQueryKey(name);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof readBackendTestApiConfigsBackendTestNameGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListAccessTokenRolesApiAuthAccessTokenTokenNameRolesGetQueryKey(tokenName);
   ...
   return  { queryKey, queryFn, enabled: tokenName !== null && tokenName !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listAccessTokenRolesApiAuthAccessTokenTokenNameRolesGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAdminListAccessTokensApiAuthUserUserIdAccessTokenGetQueryKey(userId);
   ...
   return  { queryKey, queryFn, enabled: userId !== null && userId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof adminListAccessTokensApiAuthUserUserIdAccessTokenGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetUserApiAuthUserUserIdGetQueryKey(userId);
   ...
   return  { queryKey, queryFn, enabled: userId !== null && userId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getUserApiAuthUserUserIdGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListUserRolesApiAuthUserUserIdRolesGetQueryKey(userId);
   ...
   return  { queryKey, queryFn, enabled: userId !== null && userId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listUserRolesApiAuthUserUserIdRolesGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListUsersWithRoleApiAuthRolesRoleNameUsersGetQueryKey(roleName);
   ...
   return  { queryKey, queryFn, enabled: roleName !== null && roleName !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listUsersWithRoleApiAuthRolesRoleNameUsersGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAppApiAppUserNameGetQueryKey(name,params);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAppApiAppUserNameGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAppContentApiAppUserNameSpecGetQueryKey(name,params);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAppContentApiAppUserNameSpecGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWorkflowTaskApiWorkflowNameTaskTaskNameGetQueryKey(name,taskName);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined && taskName !== null && taskName !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWorkflowTaskApiWorkflowNameTaskTaskNameGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWorkflowApiWorkflowNameGetQueryKey(name,params);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWorkflowApiWorkflowNameGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWorkflowLogsApiWorkflowNameLogsGetQueryKey(name,params);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWorkflowLogsApiWorkflowNameLogsGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWorkflowPodConditionsApiWorkflowNameEventsGetQueryKey(name,params);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWorkflowPodConditionsApiWorkflowNameEventsGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWorkflowErrorLogsApiWorkflowNameErrorLogsGetQueryKey(name,params);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWorkflowErrorLogsApiWorkflowNameErrorLogsGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWorkflowSpecApiWorkflowNameSpecGetQueryKey(name,params);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWorkflowSpecApiWorkflowNameSpecGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetOneResourceApiResourcesNameGetQueryKey(name);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getOneResourceApiResourcesNameGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SubmitWorkflowApiPoolPoolNameWorkflowPostMutationBody = TemplateSpec | null | undefined
