...
describe("date-range-utils", () => {
  describe("parseDateRangeValue", () => {
    ...
    describe("single date parsing", () => {
      ...
      it("parses datetime string as full minute range", () => {
    ...
    describe("ISO range string parsing", () => {
      it("parses date-only range string with inclusive end", () => {
      ...
      it("parses datetime range string with exact end", () => {
      ...
      it("returns null for range with start after end", () => {
  ...
  describe("edge cases", () => {
    ...
    it("handles year boundary correctly for daysAgo", () => {
    ...
    it("handles month boundary correctly for daysAgo", () => {
