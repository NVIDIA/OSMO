 ...
 * Type of configs supported by config history
 */
export type SrcUtilsConnectorsPostgresConfigHistoryType =
  (typeof SrcUtilsConnectorsPostgresConfigHistoryType)[keyof typeof SrcUtilsConnectorsPostgresConfigHistoryType];
...
export type ListPlatformsInPoolApiConfigsPoolNamePlatformGet200 = {
  [key: string]: PlatformMinimal | PlatformEditable | Platform;
};
...
export const submitWorkflowApiPoolPoolNameWorkflowPost = async (
  ...
  const res = await fetch(getSubmitWorkflowApiPoolPoolNameWorkflowPostUrl(poolName, params), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(templateSpec),
  });
...
export const getReadServiceConfigsApiConfigsServiceGetResponseMock = (
  overrideResponse: Partial<Extract<ServiceConfig, object>> = {},
): ServiceConfig => ({
  ...
  service_auth: faker.helpers.arrayElement([
    {
      ...
      login_info: {
        ...{
          ...
          token_endpoint: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  ...
  cli_config: {
    ...{
      latest_version: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
      min_supported_version: faker.helpers.arrayElement([
        faker.string.alpha({ length: { min: 10, max: 20 } }),
        undefined,
      ]),
      client_install_url: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
    },
  },
...
export const getReadWorkflowConfigsApiConfigsWorkflowGetResponseMock = (
  overrideResponse: Partial<Extract<WorkflowConfig, object>> = {},
): WorkflowConfig => ({
  workflow_data: {
    ...{
      credential: faker.helpers.arrayElement([
        {
          ...
          region: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
          override_url: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  ...
  user_workflow_limits: {
    ...{
      max_num_workflows: faker.helpers.arrayElement([faker.number.int({ min: 0 }), undefined]),
      max_num_tasks: faker.helpers.arrayElement([faker.number.int({ min: 0 }), undefined]),
...
export const getReadDatasetConfigsApiConfigsDatasetGetResponseMock = (
  overrideResponse: Partial<Extract<DatasetConfig, object>> = {},
): DatasetConfig => ({
  buckets: {
    [faker.string.alphanumeric(5)]: {
  ...
  faker.helpers.arrayElement([
    {
      pools: {
        [faker.string.alphanumeric(5)]: {
          name: faker.string.alpha({ length: { min: 10, max: 20 } }),
          description: "A test resource",
          status: faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(PoolStatus)), undefined]),
          download_type: faker.helpers.arrayElement([
            faker.helpers.arrayElement(Object.values(DownloadType)),
            undefined,
          ]),
          ...
          platforms: {
            [faker.string.alphanumeric(5)]: {
              ...
              tolerations: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
                ...
                effect: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
              })),
              labels: {
                [faker.string.alphanumeric(5)]: faker.string.alpha({ length: { min: 10, max: 20 } }),
              },
...
export const getReadPoolApiConfigsPoolNameGetResponseMock = (): Pool | PoolEditable =>
  faker.helpers.arrayElement([
    {
      name: faker.string.alpha({ length: { min: 10, max: 20 } }),
      description: "A test resource",
      status: faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(PoolStatus)), undefined]),
      download_type: faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(DownloadType)), undefined]),
      enable_maintenance: faker.datatype.boolean(),
      backend: faker.string.alpha({ length: { min: 10, max: 20 } }),
      default_platform: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
      default_exec_timeout: faker.string.alpha({ length: { min: 10, max: 20 } }),
      default_queue_timeout: faker.string.alpha({ length: { min: 10, max: 20 } }),
      max_exec_timeout: faker.string.alpha({ length: { min: 10, max: 20 } }),
      max_queue_timeout: faker.string.alpha({ length: { min: 10, max: 20 } }),
...
export const getListRolesApiConfigsRoleGetResponseMock = (): Role[] =>
  Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
    name: faker.string.alpha({ length: { min: 10, max: 20 } }),
    description: "A test resource",
...
export const getListAppsApiAppGetResponseMock = (
  ...
  apps: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
    ...
    latest_version: faker.string.alpha({ length: { min: 10, max: 20 } }),
  })),
...
export const getListWorkflowApiWorkflowGetResponseMock = (
  ...
  workflows: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
    ...
    start_time: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
    end_time: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
    queued_time: faker.number.float({ fractionDigits: 2 }),
    duration: faker.helpers.arrayElement([faker.number.float({ fractionDigits: 2 }), undefined]),
    ...
    error_logs: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
    grafana_url: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
    dashboard_url: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
    pool: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
    app_owner: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
    app_name: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
    app_version: faker.helpers.arrayElement([faker.number.int(), undefined]),
...
export const getGetWorkflowTaskApiWorkflowNameTaskTaskNameGetResponseMock = (
  ...
  node: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  start_time: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
  end_time: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
  status: faker.helpers.arrayElement(Object.values(TaskGroupStatus)),
  storage: faker.number.int(),
...
export const getGetWorkflowApiWorkflowNameGetResponseMock = (
  ...
  overview: faker.string.alpha({ length: { min: 10, max: 20 } }),
  parent_name: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  parent_job_id: faker.helpers.arrayElement([faker.number.int(), undefined]),
  dashboard_url: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  grafana_url: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  tags: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() =>
    faker.string.alpha({ length: { min: 10, max: 20 } }),
  ...
  start_time: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
  end_time: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
  exec_timeout: faker.helpers.arrayElement([faker.number.float({ fractionDigits: 2 }), undefined]),
  queue_timeout: faker.helpers.arrayElement([faker.number.float({ fractionDigits: 2 }), undefined]),
  duration: faker.helpers.arrayElement([faker.number.float({ fractionDigits: 2 }), undefined]),
  queued_time: faker.number.float({ fractionDigits: 2 }),
  status: faker.helpers.arrayElement(Object.values(WorkflowStatus)),
  ...
  groups: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
    ...
    start_time: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
    end_time: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
    processing_start_time: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
    scheduling_start_time: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
    ...
    failure_message: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
    tasks: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
      name: faker.string.alpha({ length: { min: 10, max: 20 } }),
      retry_id: faker.number.int(),
      status: faker.helpers.arrayElement(Object.values(TaskGroupStatus)),
      failure_message: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
      exit_code: faker.helpers.arrayElement([faker.number.int(), undefined]),
      logs: faker.string.alpha({ length: { min: 10, max: 20 } }),
      error_logs: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
      ...
      pod_ip: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
      task_uuid: faker.string.alpha({ length: { min: 10, max: 20 } }),
      node_name: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
      lead: faker.datatype.boolean(),
    })),
  })),
  pool: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  backend: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  app_owner: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  app_name: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  app_version: faker.helpers.arrayElement([faker.number.int(), undefined]),
  ...
  faker.helpers.arrayElement([
    {
      resources: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
        ...
        allocatable_fields: {},
        platform_allocatable_fields: faker.helpers.arrayElement([{}, undefined]),
        platform_available_fields: faker.helpers.arrayElement([{}, undefined]),
        platform_workflow_allocatable_fields: faker.helpers.arrayElement([{}, undefined]),
        config_fields: faker.helpers.arrayElement([{}, undefined]),
        backend: faker.string.alpha({ length: { min: 10, max: 20 } }),
        label_fields: faker.helpers.arrayElement([{}, undefined]),
...
export const getSubmitWorkflowApiPoolPoolNameWorkflowPostResponseMock = (
  ...
  name: faker.string.alpha({ length: { min: 10, max: 20 } }),
  overview: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  logs: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  spec: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  dashboard_url: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  ...overrideResponse,
});
...
export const getGetBucketInfoApiBucketGetResponseMock = (
  ...
  default: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  buckets: {
    [faker.string.alphanumeric(5)]: {
      path: faker.string.alpha({ length: { min: 10, max: 20 } }),
      description: "A test resource",
...
export const getChangeNameTagLabelMetadataApiBucketBucketDatasetNameAttributePostResponseMock = (
  ...
  label_response: faker.helpers.arrayElement([{ metadata: {} }, undefined]),
...
export const getGetInfoApiBucketBucketDatasetNameInfoGetResponseMock = (
  ...
  created_by: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  created_date: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
  hash_location: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  hash_location_size: faker.helpers.arrayElement([faker.number.int(), undefined]),
  labels: {},
...
export const getListDatasetFromBucketApiBucketListDatasetGetResponseMock = (
  ...
  datasets: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
    ...
    last_created: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
    hash_location: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
    hash_location_size: faker.helpers.arrayElement([faker.number.int(), undefined]),
    version_id: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
    type: faker.helpers.arrayElement(Object.values(DatasetType)),
  })),
  ...overrideResponse,
});
...
export const getGetNotificationSettingsApiProfileSettingsGetResponseMock = (
  ...
  profile: {
    ...
    slack_notification: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]),
    bucket: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
    pool: faker.helpers.arrayElement([faker.string.alpha({ length: { min: 10, max: 20 } }), undefined]),
  },
  roles: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() =>
    faker.string.alpha({ length: { min: 10, max: 20 } }),
  ...
  token: faker.helpers.arrayElement([
    {
      name: faker.string.alpha({ length: { min: 10, max: 20 } }),
      expires_at: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + "Z", undefined]),
    },
    undefined,
  ]),
  ...overrideResponse,
...
export const getGetWorkflowPluginsConfigsApiPluginsConfigsGetResponseMock = (
  overrideResponse: Partial<Extract<PluginsConfig, object>> = {},
): PluginsConfig => ({
  rsync: {
    ...{
      enabled: faker.datatype.boolean(),
...
export const getReadServiceConfigsApiConfigsServiceGetMockHandler = (
  overrideResponse?:
    | ServiceConfig
    | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ServiceConfig> | ServiceConfig),
...
export const getReadWorkflowConfigsApiConfigsWorkflowGetMockHandler = (
  overrideResponse?:
    | WorkflowConfig
    | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<WorkflowConfig> | WorkflowConfig),
  options?: RequestHandlerOptions,
) => {
  return http.get(
...
export const getReadDatasetConfigsApiConfigsDatasetGetMockHandler = (
  overrideResponse?:
    | DatasetConfig
    | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<DatasetConfig> | DatasetConfig),
  options?: RequestHandlerOptions,
) => {
  return http.get(
    "*/api/configs/dataset",
...
export const getReadPoolApiConfigsPoolNameGetMockHandler = (
  overrideResponse?:
    | Pool
    | PoolEditable
    | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<Pool | PoolEditable> | Pool | PoolEditable),
  options?: RequestHandlerOptions,
) => {
  return http.get(
...
export const getReadPlatformInPoolApiConfigsPoolNamePlatformPlatformNameGetMockHandler = (
  overrideResponse?:
    ...
    | ((
        info: Parameters<Parameters<typeof http.get>[1]>[0],
      ) => Promise<PlatformMinimal | PlatformEditable | Platform> | PlatformMinimal | PlatformEditable | Platform),
  options?: RequestHandlerOptions,
) => {
  return http.get(
    "*/api/configs/pool/:name/platform/:platformName",
...
export const getListRolesApiConfigsRoleGetMockHandler = (
  overrideResponse?: Role[] | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<Role[]> | Role[]),
  options?: RequestHandlerOptions,
) => {
  return http.get(
    "*/api/configs/role",
...
export const getGetWorkflowPluginsConfigsApiPluginsConfigsGetMockHandler = (
  overrideResponse?:
    | PluginsConfig
    | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PluginsConfig> | PluginsConfig),
  options?: RequestHandlerOptions,
) => {
  return http.get(
    "*/api/plugins/configs",
