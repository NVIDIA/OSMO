 ...
 */
export interface DefaultDataCredential {
  /** The OSMO storage URI for the data service (e.g., s3://bucket). For S3-compatible services with HTTP endpoints, set 'override_url' separately rather than pasting the full HTTPS URL here. */
  endpoint: string;
  /** The region for the data service */
  region?: string | null;
...
export interface RegistryCredential {
  ...
  /** The username for the Docker registry */
  username?: string;
  /** The authentication token (raw password) for the Docker registry */
  auth?: string;
}
...
export interface PlatformInput {
  ...
  parsed_pod_template_for_accounting?: PlatformInputParsedPodTemplateForAccounting;
}
...
export interface PlatformOutput {
  ...
  parsed_pod_template_for_accounting?: PlatformOutputParsedPodTemplateForAccounting;
}
...
export type PoolInputParsedPodTemplateForAccounting = { [key: string]: unknown };
...
export interface PoolInput {
  ...
  parsed_pod_template_for_accounting?: PoolInputParsedPodTemplateForAccounting;
  common_group_templates?: string[];
...
export type PoolOutputParsedPodTemplateForAccounting = { [key: string]: unknown };
...
export interface PoolOutput {
  ...
  parsed_pod_template_for_accounting?: PoolOutputParsedPodTemplateForAccounting;
  common_group_templates?: string[];
 ...
 */
export type uploadDatasetApiBucketBucketDatasetNamePostResponse200 = {
  data: DataUploadResponse
  status: 200
}

export type uploadDatasetApiBucketBucketDatasetNamePostResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type uploadDatasetApiBucketBucketDatasetNamePostResponseSuccess = (uploadDatasetApiBucketBucketDatasetNamePostResponse200) & {
  headers: Headers;
};
export type uploadDatasetApiBucketBucketDatasetNamePostResponseError = (uploadDatasetApiBucketBucketDatasetNamePostResponse422) & {
  headers: Headers;
};

export type uploadDatasetApiBucketBucketDatasetNamePostResponse = (uploadDatasetApiBucketBucketDatasetNamePostResponseSuccess | uploadDatasetApiBucketBucketDatasetNamePostResponseError)
...
export const uploadDatasetApiBucketBucketDatasetNamePost = async (bucket: string,
    ...
    params?: UploadDatasetApiBucketBucketDatasetNamePostParams, options?: RequestInit): Promise<uploadDatasetApiBucketBucketDatasetNamePostResponse> => {
  
  const res = await fetch(getUploadDatasetApiBucketBucketDatasetNamePostUrl(bucket,name,params),
  {      
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
  ...
  const data: uploadDatasetApiBucketBucketDatasetNamePostResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as uploadDatasetApiBucketBucketDatasetNamePostResponse
}
 ...
 * @summary Download
 */
export type downloadApiBucketBucketDatasetNameGetResponse200 = {
  data: DataDownloadResponse
  status: 200
}

export type downloadApiBucketBucketDatasetNameGetResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type downloadApiBucketBucketDatasetNameGetResponseSuccess = (downloadApiBucketBucketDatasetNameGetResponse200) & {
  headers: Headers;
};
export type downloadApiBucketBucketDatasetNameGetResponseError = (downloadApiBucketBucketDatasetNameGetResponse422) & {
  headers: Headers;
};

export type downloadApiBucketBucketDatasetNameGetResponse = (downloadApiBucketBucketDatasetNameGetResponseSuccess | downloadApiBucketBucketDatasetNameGetResponseError)
...
export const downloadApiBucketBucketDatasetNameGet = async (bucket: string,
    name: string,
    params?: DownloadApiBucketBucketDatasetNameGetParams, options?: RequestInit): Promise<downloadApiBucketBucketDatasetNameGetResponse> => {
  
  const res = await fetch(getDownloadApiBucketBucketDatasetNameGetUrl(bucket,name,params),
  {      
    ...options,
    method: 'GET'
  ...
  const data: downloadApiBucketBucketDatasetNameGetResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as downloadApiBucketBucketDatasetNameGetResponse
}
 ...
 */
export type migrateDatasetApiBucketBucketDatasetNameMigratePostResponse200 = {
  data: DataDownloadResponse
  status: 200
}

export type migrateDatasetApiBucketBucketDatasetNameMigratePostResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type migrateDatasetApiBucketBucketDatasetNameMigratePostResponseSuccess = (migrateDatasetApiBucketBucketDatasetNameMigratePostResponse200) & {
  headers: Headers;
};
export type migrateDatasetApiBucketBucketDatasetNameMigratePostResponseError = (migrateDatasetApiBucketBucketDatasetNameMigratePostResponse422) & {
  headers: Headers;
};

export type migrateDatasetApiBucketBucketDatasetNameMigratePostResponse = (migrateDatasetApiBucketBucketDatasetNameMigratePostResponseSuccess | migrateDatasetApiBucketBucketDatasetNameMigratePostResponseError)
...
export const migrateDatasetApiBucketBucketDatasetNameMigratePost = async (bucket: string,
    name: string,
    params?: MigrateDatasetApiBucketBucketDatasetNameMigratePostParams, options?: RequestInit): Promise<migrateDatasetApiBucketBucketDatasetNameMigratePostResponse> => {
  
  const res = await fetch(getMigrateDatasetApiBucketBucketDatasetNameMigratePostUrl(bucket,name,params),
  {      
    ...options,
    method: 'POST'
  ...
  const data: migrateDatasetApiBucketBucketDatasetNameMigratePostResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as migrateDatasetApiBucketBucketDatasetNameMigratePostResponse
}
 ...
 */
export type getManifestApiBucketBucketDatasetNameManifestGetResponse200 = {
  data: unknown[]
  status: 200
}

export type getManifestApiBucketBucketDatasetNameManifestGetResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type getManifestApiBucketBucketDatasetNameManifestGetResponseSuccess = (getManifestApiBucketBucketDatasetNameManifestGetResponse200) & {
  headers: Headers;
};
export type getManifestApiBucketBucketDatasetNameManifestGetResponseError = (getManifestApiBucketBucketDatasetNameManifestGetResponse422) & {
  headers: Headers;
};

export type getManifestApiBucketBucketDatasetNameManifestGetResponse = (getManifestApiBucketBucketDatasetNameManifestGetResponseSuccess | getManifestApiBucketBucketDatasetNameManifestGetResponseError)
...
export const getManifestApiBucketBucketDatasetNameManifestGet = async (bucket: string,
    name: string,
    params: GetManifestApiBucketBucketDatasetNameManifestGetParams, options?: RequestInit): Promise<getManifestApiBucketBucketDatasetNameManifestGetResponse> => {
  
  const res = await fetch(getGetManifestApiBucketBucketDatasetNameManifestGetUrl(bucket,name,params),
  {      
    ...options,
    method: 'GET'
  ...
  const data: getManifestApiBucketBucketDatasetNameManifestGetResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as getManifestApiBucketBucketDatasetNameManifestGetResponse
}
 ...
 */
export type getFileContentApiBucketBucketDatasetNameFileContentGetResponse200 = {
  data: unknown
  status: 200
}

export type getFileContentApiBucketBucketDatasetNameFileContentGetResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type getFileContentApiBucketBucketDatasetNameFileContentGetResponseSuccess = (getFileContentApiBucketBucketDatasetNameFileContentGetResponse200) & {
  headers: Headers;
};
export type getFileContentApiBucketBucketDatasetNameFileContentGetResponseError = (getFileContentApiBucketBucketDatasetNameFileContentGetResponse422) & {
  headers: Headers;
};

export type getFileContentApiBucketBucketDatasetNameFileContentGetResponse = (getFileContentApiBucketBucketDatasetNameFileContentGetResponseSuccess | getFileContentApiBucketBucketDatasetNameFileContentGetResponseError)
...
export const getFileContentApiBucketBucketDatasetNameFileContentGet = async (bucket: string,
    name: string,
    params: GetFileContentApiBucketBucketDatasetNameFileContentGetParams, options?: RequestInit): Promise<getFileContentApiBucketBucketDatasetNameFileContentGetResponse> => {
  
  const res = await fetch(getGetFileContentApiBucketBucketDatasetNameFileContentGetUrl(bucket,name,params),
  {      
    ...options,
    method: 'GET'
  ...
  const data: getFileContentApiBucketBucketDatasetNameFileContentGetResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as getFileContentApiBucketBucketDatasetNameFileContentGetResponse
}
 ...
 * @summary Get File Content
 */
export type getFileContentApiBucketBucketDatasetNameFileContentGetHeadResponse200 = {
  data: unknown
  status: 200
}

export type getFileContentApiBucketBucketDatasetNameFileContentGetHeadResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type getFileContentApiBucketBucketDatasetNameFileContentGetHeadResponseSuccess = (getFileContentApiBucketBucketDatasetNameFileContentGetHeadResponse200) & {
  headers: Headers;
};
export type getFileContentApiBucketBucketDatasetNameFileContentGetHeadResponseError = (getFileContentApiBucketBucketDatasetNameFileContentGetHeadResponse422) & {
  headers: Headers;
};

export type getFileContentApiBucketBucketDatasetNameFileContentGetHeadResponse = (getFileContentApiBucketBucketDatasetNameFileContentGetHeadResponseSuccess | getFileContentApiBucketBucketDatasetNameFileContentGetHeadResponseError)
...
export const getFileContentApiBucketBucketDatasetNameFileContentGetHead = async (bucket: string,
    name: string,
    params: GetFileContentApiBucketBucketDatasetNameFileContentGetHeadParams, options?: RequestInit): Promise<getFileContentApiBucketBucketDatasetNameFileContentGetHeadResponse> => {
  
  const res = await fetch(getGetFileContentApiBucketBucketDatasetNameFileContentGetHeadUrl(bucket,name,params),
  {      
    ...options,
    method: 'HEAD'
  ...
  const data: getFileContentApiBucketBucketDatasetNameFileContentGetHeadResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as getFileContentApiBucketBucketDatasetNameFileContentGetHeadResponse
}
 ...
 */
export type getPathInformationApiBucketBucketLocationGetResponse200 = {
  data: unknown
  status: 200
}

export type getPathInformationApiBucketBucketLocationGetResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type getPathInformationApiBucketBucketLocationGetResponseSuccess = (getPathInformationApiBucketBucketLocationGetResponse200) & {
  headers: Headers;
};
export type getPathInformationApiBucketBucketLocationGetResponseError = (getPathInformationApiBucketBucketLocationGetResponse422) & {
  headers: Headers;
};

export type getPathInformationApiBucketBucketLocationGetResponse = (getPathInformationApiBucketBucketLocationGetResponseSuccess | getPathInformationApiBucketBucketLocationGetResponseError)
...
export const getPathInformationApiBucketBucketLocationGet = async (bucket: string, options?: RequestInit): Promise<getPathInformationApiBucketBucketLocationGetResponse> => {
  
  const res = await fetch(getGetPathInformationApiBucketBucketLocationGetUrl(bucket),
  {      
    ...options,
    method: 'GET'
  ...
  const data: getPathInformationApiBucketBucketLocationGetResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as getPathInformationApiBucketBucketLocationGetResponse
}
 ...
 */
export type updateCollectionApiBucketBucketDatasetNameRecollectPostResponse200 = {
  data: DataUpdateResponse
  status: 200
}

export type updateCollectionApiBucketBucketDatasetNameRecollectPostResponse422 = {
  data: HTTPValidationError
  status: 422
}

export type updateCollectionApiBucketBucketDatasetNameRecollectPostResponseSuccess = (updateCollectionApiBucketBucketDatasetNameRecollectPostResponse200) & {
  headers: Headers;
};
export type updateCollectionApiBucketBucketDatasetNameRecollectPostResponseError = (updateCollectionApiBucketBucketDatasetNameRecollectPostResponse422) & {
  headers: Headers;
};

export type updateCollectionApiBucketBucketDatasetNameRecollectPostResponse = (updateCollectionApiBucketBucketDatasetNameRecollectPostResponseSuccess | updateCollectionApiBucketBucketDatasetNameRecollectPostResponseError)
...
export const updateCollectionApiBucketBucketDatasetNameRecollectPost = async (bucket: string,
    name: string,
    bodyUpdateCollectionApiBucketBucketDatasetNameRecollectPost: BodyUpdateCollectionApiBucketBucketDatasetNameRecollectPost, options?: RequestInit): Promise<updateCollectionApiBucketBucketDatasetNameRecollectPostResponse> => {
  
  const res = await fetch(getUpdateCollectionApiBucketBucketDatasetNameRecollectPostUrl(bucket,name),
  {      
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
  ...
  const data: updateCollectionApiBucketBucketDatasetNameRecollectPostResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as updateCollectionApiBucketBucketDatasetNameRecollectPostResponse
}
...
export const getReadServiceConfigsApiConfigsServiceGetResponseMock = (overrideResponse: Partial<Extract<ServiceConfigOutput, object>> = {}): ServiceConfigOutput => ({service_base_url: faker.string.alpha({length: {min: 10, max: 20}}), service_auth: faker.helpers.arrayElement([{keys: {
        [faker.string.alphanumeric(5)]: {public_key: faker.string.alpha({length: {min: 10, max: 20}}), private_key: faker.internet.password()}
      }, active_key: faker.string.alpha({length: {min: 10, max: 20}}), issuer: faker.string.alpha({length: {min: 10, max: 20}}), audience: faker.string.alpha({length: {min: 10, max: 20}}), user_roles: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), ctrl_roles: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), login_info: {device_endpoint: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), device_client_id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), browser_endpoint: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), browser_client_id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), token_endpoint: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), logout_endpoint: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined])}, max_token_duration: faker.string.alpha({length: {min: 10, max: 20}})}, undefined]), cli_config: {latest_version: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), min_supported_version: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), client_install_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined])}, max_pod_restart_limit: faker.string.alpha({length: {min: 10, max: 20}}), agent_queue_size: faker.number.int(), ...overrideResponse})
...
export const getReadWorkflowConfigsApiConfigsWorkflowGetResponseMock = (overrideResponse: Partial<Extract<WorkflowConfigOutput, object>> = {}): WorkflowConfigOutput => ({workflow_data: {credential: faker.helpers.arrayElement([faker.helpers.arrayElement([{endpoint: faker.string.alpha({length: {min: 10, max: 20}}), region: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), override_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), addressing_style: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(['virtual','path','auto'] as const),null,]), undefined]), access_key_id: faker.string.alpha({length: {min: 10, max: 20}}), access_key: faker.internet.password()},{endpoint: faker.string.alpha({length: {min: 10, max: 20}}), region: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), override_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), addressing_style: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(['virtual','path','auto'] as const),null,]), undefined])},null,]), undefined]), base_url: faker.string.alpha({length: {min: 10, max: 20}}), websocket_timeout: faker.number.int(), data_timeout: faker.number.int(), download_type: faker.helpers.arrayElement(Object.values(DownloadType))}, workflow_log: {credential: faker.helpers.arrayElement([faker.helpers.arrayElement([{endpoint: faker.string.alpha({length: {min: 10, max: 20}}), region: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), override_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), addressing_style: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(['virtual','path','auto'] as const),null,]), undefined]), access_key_id: faker.string.alpha({length: {min: 10, max: 20}}), access_key: faker.internet.password()},{endpoint: faker.string.alpha({length: {min: 10, max: 20}}), region: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), override_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), addressing_style: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(['virtual','path','auto'] as const),null,]), undefined])},null,]), undefined])}, workflow_app: {credential: faker.helpers.arrayElement([faker.helpers.arrayElement([{endpoint: faker.string.alpha({length: {min: 10, max: 20}}), region: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), override_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), addressing_style: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(['virtual','path','auto'] as const),null,]), undefined]), access_key_id: faker.string.alpha({length: {min: 10, max: 20}}), access_key: faker.internet.password()},{endpoint: faker.string.alpha({length: {min: 10, max: 20}}), region: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), override_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), addressing_style: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(['virtual','path','auto'] as const),null,]), undefined])},null,]), undefined])}, workflow_info: {tags: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), max_name_length: faker.number.int()}, backend_images: {init: faker.string.alpha({length: {min: 10, max: 20}}), client: faker.string.alpha({length: {min: 10, max: 20}}), credential: {registry: faker.string.alpha({length: {min: 10, max: 20}}), username: faker.string.alpha({length: {min: 10, max: 20}}), auth: faker.internet.password()}}, workflow_alerts: {slack_token: faker.internet.password(), smtp_settings: {host: faker.string.alpha({length: {min: 10, max: 20}}), sender: faker.string.alpha({length: {min: 10, max: 20}}), password: faker.internet.password()}}, credential_config: {disable_registry_validation: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), disable_data_validation: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}})))}, user_workflow_limits: {max_num_workflows: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int({min: 0}),null,]), undefined]), max_num_tasks: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int({min: 0}),null,]), undefined]), jinja_sandbox_workers: faker.number.int(), jinja_sandbox_max_time: faker.number.float({fractionDigits: 2}), jinja_sandbox_memory_limit: faker.number.int()}, plugins_config: {rsync: {enabled: faker.datatype.boolean(), enable_telemetry: faker.datatype.boolean(), read_bandwidth_limit: faker.number.int({min: 0}), write_bandwidth_limit: faker.number.int({min: 0}), allowed_paths: {
...
export const getReadDatasetConfigsApiConfigsDatasetGetResponseMock = (overrideResponse: Partial<Extract<DatasetConfigOutput, object>> = {}): DatasetConfigOutput => ({buckets: {
        [faker.string.alphanumeric(5)]: {dataset_path: faker.helpers.fromRegExp('(^swift://[^/,;*]+(/[^/,;*]+){2,}/*$|^s3://[^/,;*]+(/[^/,;*]+)*/*$|^gs://[^/,;*]+(/[^/,;*]+)*/*$|^tos://[^/,;*]+(/[^/,;*]+)+/*$|^azure://[^/,;*]+(/[^/,;*]+)+/*$)'), region: faker.string.alpha({length: {min: 10, max: 20}}), description: 'A test resource', mode: faker.string.alpha({length: {min: 10, max: 20}}), default_credential: faker.helpers.arrayElement([faker.helpers.arrayElement([{endpoint: faker.string.alpha({length: {min: 10, max: 20}}), region: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), override_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), addressing_style: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(['virtual','path','auto'] as const),null,]), undefined]), access_key_id: faker.string.alpha({length: {min: 10, max: 20}}), access_key: faker.internet.password()},null,]), undefined])}
...
export const getListBackendsApiConfigsBackendGetResponseMock = (overrideResponse: Partial<Extract<ListBackendsResponse, object>> = {}): ListBackendsResponse => ({backends: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({name: faker.string.alpha({length: {min: 10, max: 20}}), description: 'A test resource', version: faker.string.alpha({length: {min: 10, max: 20}}), k8s_uid: faker.string.alpha({length: {min: 10, max: 20}}), k8s_namespace: faker.string.alpha({length: {min: 10, max: 20}}), dashboard_url: faker.string.alpha({length: {min: 10, max: 20}}), grafana_url: faker.string.alpha({length: {min: 10, max: 20}}), tests: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), scheduler_settings: {scheduler_type: 'kai', scheduler_name: faker.string.alpha({length: {min: 10, max: 20}}), scheduler_timeout: faker.number.int()}, node_conditions: {rules: faker.helpers.arrayElement([faker.helpers.arrayElement([{
        [faker.string.alphanumeric(5)]: faker.string.alpha({length: {min: 10, max: 20}})
      },null,]), undefined]), prefix: faker.string.alpha({length: {min: 10, max: 20}})}, last_heartbeat: faker.date.past().toISOString().slice(0, 19) + 'Z', created_date: faker.date.past().toISOString().slice(0, 19) + 'Z', router_address: faker.string.alpha({length: {min: 10, max: 20}}), online: faker.datatype.boolean()})), ...overrideResponse})
...
export const getListPoolsApiConfigsPoolGetResponseMock = (): VerbosePoolConfig | EditablePoolConfig => (faker.helpers.arrayElement([{pools: {
        [faker.string.alphanumeric(5)]: {name: faker.string.alpha({length: {min: 10, max: 20}}), description: 'A test resource', status: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(PoolStatus)),null,]), undefined]), download_type: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(DownloadType)),null,]), undefined]), enable_maintenance: faker.datatype.boolean(), backend: faker.string.alpha({length: {min: 10, max: 20}}), default_platform: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), default_exec_timeout: faker.string.alpha({length: {min: 10, max: 20}}), default_queue_timeout: faker.string.alpha({length: {min: 10, max: 20}}), max_exec_timeout: faker.string.alpha({length: {min: 10, max: 20}}), max_queue_timeout: faker.string.alpha({length: {min: 10, max: 20}}), default_exit_actions: {
        [faker.string.alphanumeric(5)]: faker.string.alpha({length: {min: 10, max: 20}})
      }, resources: {gpu: faker.helpers.arrayElement([faker.helpers.arrayElement([{guarantee: faker.number.int(), maximum: faker.number.int(), weight: faker.number.int()},null,]), undefined])}, topology_keys: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({key: faker.string.alpha({length: {min: 10, max: 20}}), label: faker.string.alpha({length: {min: 10, max: 20}})})), common_default_variables: {}, common_resource_validations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), parsed_resource_validations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({operator: faker.helpers.arrayElement(Object.values(OperatorType)), left_operand: faker.string.alpha({length: {min: 10, max: 20}}), right_operand: faker.string.alpha({length: {min: 10, max: 20}}), assert_message: faker.string.alpha({length: {min: 10, max: 20}})})), common_pod_template: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), parsed_pod_template: {}, parsed_pod_template_for_accounting: {}, common_group_templates: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), parsed_group_templates: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({})), platforms: {
        [faker.string.alphanumeric(5)]: {description: 'A test resource', host_network_allowed: faker.datatype.boolean(), privileged_allowed: faker.datatype.boolean(), allowed_mounts: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), default_mounts: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), tolerations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({key: faker.string.alpha({length: {min: 10, max: 20}}), operator: faker.string.alpha({length: {min: 10, max: 20}}), value: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), effect: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined])})), labels: {
        [faker.string.alphanumeric(5)]: faker.string.alpha({length: {min: 10, max: 20}})
      ...
      }, last_heartbeat: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined])}
      }},{pools: {
        [faker.string.alphanumeric(5)]: {name: faker.string.alpha({length: {min: 10, max: 20}}), description: 'A test resource', status: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(PoolStatus)),null,]), undefined]), download_type: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(DownloadType)),null,]), undefined]), enable_maintenance: faker.datatype.boolean(), backend: faker.string.alpha({length: {min: 10, max: 20}}), default_platform: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), default_exec_timeout: faker.string.alpha({length: {min: 10, max: 20}}), default_queue_timeout: faker.string.alpha({length: {min: 10, max: 20}}), max_exec_timeout: faker.string.alpha({length: {min: 10, max: 20}}), max_queue_timeout: faker.string.alpha({length: {min: 10, max: 20}}), default_exit_actions: {
        [faker.string.alphanumeric(5)]: faker.string.alpha({length: {min: 10, max: 20}})
...
export const getReadPoolApiConfigsPoolNameGetResponseMock = (): PoolOutput | PoolEditable => (faker.helpers.arrayElement([{name: faker.string.alpha({length: {min: 10, max: 20}}), description: 'A test resource', status: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(PoolStatus)),null,]), undefined]), download_type: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(DownloadType)),null,]), undefined]), enable_maintenance: faker.datatype.boolean(), backend: faker.string.alpha({length: {min: 10, max: 20}}), default_platform: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), default_exec_timeout: faker.string.alpha({length: {min: 10, max: 20}}), default_queue_timeout: faker.string.alpha({length: {min: 10, max: 20}}), max_exec_timeout: faker.string.alpha({length: {min: 10, max: 20}}), max_queue_timeout: faker.string.alpha({length: {min: 10, max: 20}}), default_exit_actions: {
        [faker.string.alphanumeric(5)]: faker.string.alpha({length: {min: 10, max: 20}})
      }, resources: {gpu: faker.helpers.arrayElement([faker.helpers.arrayElement([{guarantee: faker.number.int(), maximum: faker.number.int(), weight: faker.number.int()},null,]), undefined])}, topology_keys: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({key: faker.string.alpha({length: {min: 10, max: 20}}), label: faker.string.alpha({length: {min: 10, max: 20}})})), common_default_variables: {}, common_resource_validations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), parsed_resource_validations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({operator: faker.helpers.arrayElement(Object.values(OperatorType)), left_operand: faker.string.alpha({length: {min: 10, max: 20}}), right_operand: faker.string.alpha({length: {min: 10, max: 20}}), assert_message: faker.string.alpha({length: {min: 10, max: 20}})})), common_pod_template: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), parsed_pod_template: {}, parsed_pod_template_for_accounting: {}, common_group_templates: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), parsed_group_templates: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({})), platforms: {
        [faker.string.alphanumeric(5)]: {description: 'A test resource', host_network_allowed: faker.datatype.boolean(), privileged_allowed: faker.datatype.boolean(), allowed_mounts: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), default_mounts: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), tolerations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({key: faker.string.alpha({length: {min: 10, max: 20}}), operator: faker.string.alpha({length: {min: 10, max: 20}}), value: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), effect: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined])})), labels: {
        [faker.string.alphanumeric(5)]: faker.string.alpha({length: {min: 10, max: 20}})
      }, default_variables: {}, resource_validations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), parsed_resource_validations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({operator: faker.helpers.arrayElement(Object.values(OperatorType)), left_operand: faker.string.alpha({length: {min: 10, max: 20}}), right_operand: faker.string.alpha({length: {min: 10, max: 20}}), assert_message: faker.string.alpha({length: {min: 10, max: 20}})})), override_pod_template: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), parsed_pod_template: {}, parsed_pod_template_for_accounting: {}}
      }, last_heartbeat: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined])},{name: faker.string.alpha({length: {min: 10, max: 20}}), description: 'A test resource', status: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(PoolStatus)),null,]), undefined]), download_type: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(DownloadType)),null,]), undefined]), enable_maintenance: faker.datatype.boolean(), backend: faker.string.alpha({length: {min: 10, max: 20}}), default_platform: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), default_exec_timeout: faker.string.alpha({length: {min: 10, max: 20}}), default_queue_timeout: faker.string.alpha({length: {min: 10, max: 20}}), max_exec_timeout: faker.string.alpha({length: {min: 10, max: 20}}), max_queue_timeout: faker.string.alpha({length: {min: 10, max: 20}}), default_exit_actions: {
        [faker.string.alphanumeric(5)]: faker.string.alpha({length: {min: 10, max: 20}})
      }, resources: {gpu: faker.helpers.arrayElement([faker.helpers.arrayElement([{guarantee: faker.number.int(), maximum: faker.number.int(), weight: faker.number.int()},null,]), undefined])}, topology_keys: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({key: faker.string.alpha({length: {min: 10, max: 20}}), label: faker.string.alpha({length: {min: 10, max: 20}})})), common_default_variables: {}, common_resource_validations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), common_pod_template: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), common_group_templates: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), platforms: {
        [faker.string.alphanumeric(5)]: {description: 'A test resource', host_network_allowed: faker.datatype.boolean(), privileged_allowed: faker.datatype.boolean(), allowed_mounts: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), default_variables: {}, resource_validations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), override_pod_template: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}})))}
      }},]))
...
export const getReadPlatformInPoolApiConfigsPoolNamePlatformPlatformNameGetResponseMock = (): PlatformMinimal | PlatformEditable | PlatformOutput => (faker.helpers.arrayElement([{description: 'A test resource', host_network_allowed: faker.datatype.boolean(), privileged_allowed: faker.datatype.boolean(), allowed_mounts: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), default_mounts: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}})))},{description: 'A test resource', host_network_allowed: faker.datatype.boolean(), privileged_allowed: faker.datatype.boolean(), allowed_mounts: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), default_variables: {}, resource_validations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), override_pod_template: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}})))},{description: 'A test resource', host_network_allowed: faker.datatype.boolean(), privileged_allowed: faker.datatype.boolean(), allowed_mounts: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), default_mounts: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), tolerations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({key: faker.string.alpha({length: {min: 10, max: 20}}), operator: faker.string.alpha({length: {min: 10, max: 20}}), value: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), effect: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined])})), labels: {
        [faker.string.alphanumeric(5)]: faker.string.alpha({length: {min: 10, max: 20}})
      }, default_variables: {}, resource_validations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), parsed_resource_validations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({operator: faker.helpers.arrayElement(Object.values(OperatorType)), left_operand: faker.string.alpha({length: {min: 10, max: 20}}), right_operand: faker.string.alpha({length: {min: 10, max: 20}}), assert_message: faker.string.alpha({length: {min: 10, max: 20}})})), override_pod_template: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), parsed_pod_template: {}, parsed_pod_template_for_accounting: {}},]))
...
export const getListRolesApiConfigsRoleGetResponseMock = (): RoleOutput[] => (Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({name: faker.string.alpha({length: {min: 10, max: 20}}), description: 'A test resource', policies: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({effect: faker.helpers.arrayElement(Object.values(PolicyEffect)), actions: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), resources: faker.helpers.arrayElement([Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), undefined])})), immutable: faker.datatype.boolean(), sync_mode: faker.helpers.arrayElement(Object.values(SyncMode)), external_roles: faker.helpers.arrayElement([faker.helpers.arrayElement([Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))),null,]), undefined])})))

export const getReadRoleApiConfigsRoleNameGetResponseMock = (overrideResponse: Partial<Extract<RoleOutput, object>> = {}): RoleOutput => ({name: faker.string.alpha({length: {min: 10, max: 20}}), description: 'A test resource', policies: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({effect: faker.helpers.arrayElement(Object.values(PolicyEffect)), actions: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), resources: faker.helpers.arrayElement([Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), undefined])})), immutable: faker.datatype.boolean(), sync_mode: faker.helpers.arrayElement(Object.values(SyncMode)), external_roles: faker.helpers.arrayElement([faker.helpers.arrayElement([Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))),null,]), undefined]), ...overrideResponse})
...
export const getListUsersApiAuthUserGetResponseMock = (overrideResponse: Partial<Extract<UserListResponse, object>> = {}): UserListResponse => ({total_results: faker.number.int(), start_index: faker.number.int(), items_per_page: faker.number.int(), users: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({id: faker.string.alpha({length: {min: 10, max: 20}}), created_at: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), created_by: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined])})), ...overrideResponse})

export const getCreateUserApiAuthUserPostResponseMock = (overrideResponse: Partial<Extract<User, object>> = {}): User => ({id: faker.string.alpha({length: {min: 10, max: 20}}), created_at: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), created_by: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), ...overrideResponse})

export const getGetUserApiAuthUserUserIdGetResponseMock = (overrideResponse: Partial<Extract<UserWithRoles, object>> = {}): UserWithRoles => ({id: faker.string.alpha({length: {min: 10, max: 20}}), created_at: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), created_by: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), roles: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({role_name: faker.string.alpha({length: {min: 10, max: 20}}), assigned_by: faker.string.alpha({length: {min: 10, max: 20}}), assigned_at: faker.date.past().toISOString().slice(0, 19) + 'Z'})), ...overrideResponse})
...
export const getListWorkflowApiWorkflowGetResponseMock = (overrideResponse: Partial<Extract<SrcServiceCoreWorkflowObjectsListResponse, object>> = {}): SrcServiceCoreWorkflowObjectsListResponse => ({workflows: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({user: faker.string.alpha({length: {min: 10, max: 20}}), name: faker.string.alpha({length: {min: 10, max: 20}}), workflow_uuid: faker.string.alpha({length: {min: 10, max: 20}}), submit_time: faker.date.past().toISOString().slice(0, 19) + 'Z', start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), end_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), queued_time: faker.number.float({fractionDigits: 2}), duration: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.float({fractionDigits: 2}),null,]), undefined]), status: faker.helpers.arrayElement(Object.values(WorkflowStatus)), overview: faker.string.alpha({length: {min: 10, max: 20}}), logs: faker.string.alpha({length: {min: 10, max: 20}}), error_logs: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), grafana_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), dashboard_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), pool: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), app_owner: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), app_name: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), app_version: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), priority: faker.string.alpha({length: {min: 10, max: 20}})})), more_entries: faker.datatype.boolean(), ...overrideResponse})

export const getGetWorkflowTaskApiWorkflowNameTaskTaskNameGetResponseMock = (overrideResponse: Partial<Extract<TaskEntry, object>> = {}): TaskEntry => ({workflow_id: faker.string.alpha({length: {min: 10, max: 20}}), task_name: faker.string.alpha({length: {min: 10, max: 20}}), node: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), end_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), status: faker.helpers.arrayElement(Object.values(TaskGroupStatus)), storage: faker.number.float({fractionDigits: 2}), cpu: faker.number.int(), memory: faker.number.float({fractionDigits: 2}), gpu: faker.number.int(), ...overrideResponse})

export const getListTaskApiTaskGetResponseMock = (): ListTaskSummaryResponse | ListTaskResponse | ListTaskAggregatedResponse => (faker.helpers.arrayElement([{summaries: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({user: faker.string.alpha({length: {min: 10, max: 20}}), pool: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), storage: faker.number.float({fractionDigits: 2}), cpu: faker.number.int(), memory: faker.number.float({fractionDigits: 2}), gpu: faker.number.int(), priority: faker.string.alpha({length: {min: 10, max: 20}})}))},{tasks: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({user: faker.string.alpha({length: {min: 10, max: 20}}), workflow_id: faker.string.alpha({length: {min: 10, max: 20}}), workflow_uuid: faker.string.alpha({length: {min: 10, max: 20}}), task_name: faker.string.alpha({length: {min: 10, max: 20}}), retry_id: faker.number.int(), pool: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), node: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), end_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), duration: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.float({fractionDigits: 2}),null,]), undefined]), status: faker.helpers.arrayElement(Object.values(TaskGroupStatus)), overview: faker.string.alpha({length: {min: 10, max: 20}}), logs: faker.string.alpha({length: {min: 10, max: 20}}), error_logs: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), grafana_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), dashboard_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), storage: faker.number.float({fractionDigits: 2}), cpu: faker.number.int(), memory: faker.number.float({fractionDigits: 2}), gpu: faker.number.int(), priority: faker.string.alpha({length: {min: 10, max: 20}})}))},{summaries: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({user: faker.string.alpha({length: {min: 10, max: 20}}), pool: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), storage: faker.number.float({fractionDigits: 2}), cpu: faker.number.int(), memory: faker.number.float({fractionDigits: 2}), gpu: faker.number.int(), priority: faker.string.alpha({length: {min: 10, max: 20}}), workflow_id: faker.string.alpha({length: {min: 10, max: 20}})}))},]))

export const getGetWorkflowApiWorkflowNameGetResponseMock = (overrideResponse: Partial<Extract<WorkflowQueryResponse, object>> = {}): WorkflowQueryResponse => ({name: faker.string.alpha({length: {min: 10, max: 20}}), uuid: faker.string.alpha({length: {min: 10, max: 20}}), submitted_by: faker.string.alpha({length: {min: 10, max: 20}}), cancelled_by: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), spec: faker.string.alpha({length: {min: 10, max: 20}}), template_spec: faker.string.alpha({length: {min: 10, max: 20}}), logs: faker.string.alpha({length: {min: 10, max: 20}}), events: faker.string.alpha({length: {min: 10, max: 20}}), overview: faker.string.alpha({length: {min: 10, max: 20}}), parent_name: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), parent_job_id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), dashboard_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), grafana_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), tags: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), submit_time: faker.date.past().toISOString().slice(0, 19) + 'Z', start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), end_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), exec_timeout: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.float({fractionDigits: 2}),null,]), undefined]), queue_timeout: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.float({fractionDigits: 2}),null,]), undefined]), duration: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.float({fractionDigits: 2}),null,]), undefined]), queued_time: faker.number.float({fractionDigits: 2}), status: faker.helpers.arrayElement(Object.values(WorkflowStatus)), outputs: faker.string.alpha({length: {min: 10, max: 20}}), groups: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({name: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.helpers.arrayElement(Object.values(TaskGroupStatus)), start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), end_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), processing_start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), scheduling_start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), initializing_start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), remaining_upstream_groups: faker.helpers.arrayElement([faker.helpers.arrayElement([Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))),null,]), undefined]), downstream_groups: faker.helpers.arrayElement([faker.helpers.arrayElement([Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))),null,]), undefined]), failure_message: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), tasks: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({name: faker.string.alpha({length: {min: 10, max: 20}}), retry_id: faker.number.int(), status: faker.helpers.arrayElement(Object.values(TaskGroupStatus)), failure_message: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), exit_code: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), logs: faker.string.alpha({length: {min: 10, max: 20}}), error_logs: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), processing_start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), scheduling_start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), initializing_start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), events: faker.string.alpha({length: {min: 10, max: 20}}), start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), end_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), input_download_start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), input_download_end_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), output_upload_start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), dashboard_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), pod_name: faker.string.alpha({length: {min: 10, max: 20}}), pod_ip: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), task_uuid: faker.string.alpha({length: {min: 10, max: 20}}), node_name: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), lead: faker.datatype.boolean()}))})), pool: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), backend: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), app_owner: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), app_name: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), app_version: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), plugins: {rsync: faker.datatype.boolean()}, priority: faker.string.alpha({length: {min: 10, max: 20}}), ...overrideResponse})
...
export const getGetUserCredentialApiCredentialsGetResponseMock = (overrideResponse: Partial<Extract<CredentialGetResponse, object>> = {}): CredentialGetResponse => ({credentials: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({
        [faker.string.alphanumeric(5)]: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,])
      })), ...overrideResponse})
...
export const getGetResourcesApiResourcesGetResponseMock = (): ResourcesResponse | PoolResourcesResponse => (faker.helpers.arrayElement([{resources: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({hostname: (() => `node-${Math.random().toString(36).slice(2, 7)}.cluster.local`)(), exposed_fields: {}, taints: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({})), usage_fields: {}, conditions: faker.helpers.arrayElement([faker.helpers.arrayElement([Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))),null,]), undefined]), non_workflow_usage_fields: {}, allocatable_fields: {}, platform_allocatable_fields: faker.helpers.arrayElement([faker.helpers.arrayElement([null,]), undefined]), platform_available_fields: faker.helpers.arrayElement([faker.helpers.arrayElement([null,]), undefined]), platform_workflow_allocatable_fields: faker.helpers.arrayElement([faker.helpers.arrayElement([null,]), undefined]), config_fields: faker.helpers.arrayElement([faker.helpers.arrayElement([null,]), undefined]), backend: faker.string.alpha({length: {min: 10, max: 20}}), label_fields: faker.helpers.arrayElement([faker.helpers.arrayElement([null,]), undefined]), pool_platform_labels: {
...
export const getGetPoolsApiPoolGetResponseMock = (overrideResponse: Partial<Extract<MinimalPoolConfig, object>> = {}): MinimalPoolConfig => ({pools: {
        [faker.string.alphanumeric(5)]: {name: faker.string.alpha({length: {min: 10, max: 20}}), description: 'A test resource', status: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(PoolStatus)),null,]), undefined]), download_type: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(DownloadType)),null,]), undefined]), enable_maintenance: faker.datatype.boolean(), backend: faker.string.alpha({length: {min: 10, max: 20}}), default_platform: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), default_exec_timeout: faker.string.alpha({length: {min: 10, max: 20}}), default_queue_timeout: faker.string.alpha({length: {min: 10, max: 20}}), max_exec_timeout: faker.string.alpha({length: {min: 10, max: 20}}), max_queue_timeout: faker.string.alpha({length: {min: 10, max: 20}}), default_exit_actions: {
        [faker.string.alphanumeric(5)]: faker.string.alpha({length: {min: 10, max: 20}})
      }, resources: {gpu: faker.helpers.arrayElement([faker.helpers.arrayElement([{guarantee: faker.number.int(), maximum: faker.number.int(), weight: faker.number.int()},null,]), undefined])}, topology_keys: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({key: faker.string.alpha({length: {min: 10, max: 20}}), label: faker.string.alpha({length: {min: 10, max: 20}})})), platforms: {
...
export const getSubmitWorkflowApiPoolPoolNameWorkflowPostResponseMock = (overrideResponse: Partial<Extract<SubmitResponse, object>> = {}): SubmitResponse => ({name: faker.string.alpha({length: {min: 10, max: 20}}), overview: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), logs: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), spec: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), dashboard_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), ...overrideResponse})

export const getRestartWorkflowApiPoolPoolNameWorkflowWorkflowIdRestartPostResponseMock = (overrideResponse: Partial<Extract<SubmitResponse, object>> = {}): SubmitResponse => ({name: faker.string.alpha({length: {min: 10, max: 20}}), overview: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), logs: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), spec: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), dashboard_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), ...overrideResponse})

export const getGetBucketInfoApiBucketGetResponseMock = (overrideResponse: Partial<Extract<BucketInfoResponse, object>> = {}): BucketInfoResponse => ({default: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), buckets: {
...
export const getUploadDatasetApiBucketBucketDatasetNamePostResponseMock = (overrideResponse: Partial<Extract<DataUploadResponse, object>> = {}): DataUploadResponse => ({version_id: faker.string.alpha({length: {min: 10, max: 20}}), region: faker.string.alpha({length: {min: 10, max: 20}}), storage_path: faker.string.alpha({length: {min: 10, max: 20}}), manifest_path: faker.string.alpha({length: {min: 10, max: 20}}), ...overrideResponse})

export const getDownloadApiBucketBucketDatasetNameGetResponseMock = (overrideResponse: Partial<Extract<DataDownloadResponse, object>> = {}): DataDownloadResponse => ({dataset_names: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), dataset_versions: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), locations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), new_locations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), is_collection: faker.datatype.boolean(), ...overrideResponse})
...
export const getMigrateDatasetApiBucketBucketDatasetNameMigratePostResponseMock = (overrideResponse: Partial<Extract<DataDownloadResponse, object>> = {}): DataDownloadResponse => ({dataset_names: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), dataset_versions: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), locations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), new_locations: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), is_collection: faker.datatype.boolean(), ...overrideResponse})

export const getChangeNameTagLabelMetadataApiBucketBucketDatasetNameAttributePostResponseMock = (overrideResponse: Partial<Extract<DataAttributeResponse, object>> = {}): DataAttributeResponse => ({tag_response: faker.helpers.arrayElement([faker.helpers.arrayElement([{version_id: faker.string.alpha({length: {min: 10, max: 20}}), tags: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}})))},null,]), undefined]), label_response: faker.helpers.arrayElement([faker.helpers.arrayElement([{metadata: {}},null,]), undefined]), metadata_response: faker.helpers.arrayElement([faker.helpers.arrayElement([{metadata: {}},null,]), undefined]), ...overrideResponse})

export const getGetInfoApiBucketBucketDatasetNameInfoGetResponseMock = (overrideResponse: Partial<Extract<DataInfoResponse, object>> = {}): DataInfoResponse => ({name: faker.string.alpha({length: {min: 10, max: 20}}), id: faker.string.alpha({length: {min: 10, max: 20}}), bucket: faker.string.alpha({length: {min: 10, max: 20}}), created_by: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), created_date: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), hash_location: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), hash_location_size: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), labels: {}, type: faker.helpers.arrayElement(Object.values(DatasetType)), versions: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.helpers.arrayElement([{name: faker.string.alpha({length: {min: 10, max: 20}}), version: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.helpers.arrayElement(Object.values(DatasetStatus)), created_by: faker.string.alpha({length: {min: 10, max: 20}}), created_date: faker.date.past().toISOString().slice(0, 19) + 'Z', last_used: faker.date.past().toISOString().slice(0, 19) + 'Z', size: faker.number.int(), checksum: faker.string.alpha({length: {min: 10, max: 20}}), location: faker.string.alpha({length: {min: 10, max: 20}}), uri: faker.string.alpha({length: {min: 10, max: 20}}), metadata: {}, tags: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), collections: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}})))},{name: faker.string.alpha({length: {min: 10, max: 20}}), version: faker.string.alpha({length: {min: 10, max: 20}}), location: faker.string.alpha({length: {min: 10, max: 20}}), uri: faker.string.alpha({length: {min: 10, max: 20}}), hash_location: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), size: faker.number.int()},]))), ...overrideResponse})

export const getListDatasetFromBucketApiBucketListDatasetGetResponseMock = (overrideResponse: Partial<Extract<DataListResponse, object>> = {}): DataListResponse => ({datasets: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({name: faker.string.alpha({length: {min: 10, max: 20}}), id: faker.string.alpha({length: {min: 10, max: 20}}), bucket: faker.string.alpha({length: {min: 10, max: 20}}), create_time: faker.date.past().toISOString().slice(0, 19) + 'Z', last_created: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), hash_location: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), hash_location_size: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), version_id: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), type: faker.helpers.arrayElement(Object.values(DatasetType))})), ...overrideResponse})

export const getQueryDatasetApiBucketBucketQueryGetResponseMock = (overrideResponse: Partial<Extract<DataQueryResponse, object>> = {}): DataQueryResponse => ({type: faker.helpers.arrayElement(Object.values(DatasetQueryType)), datasets: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.helpers.arrayElement([{name: faker.string.alpha({length: {min: 10, max: 20}}), id: faker.string.alpha({length: {min: 10, max: 20}}), bucket: faker.string.alpha({length: {min: 10, max: 20}}), created_by: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), created_date: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), hash_location: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), hash_location_size: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), labels: {}, type: faker.helpers.arrayElement(Object.values(DatasetType)), versions: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.helpers.arrayElement([{name: faker.string.alpha({length: {min: 10, max: 20}}), version: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.helpers.arrayElement(Object.values(DatasetStatus)), created_by: faker.string.alpha({length: {min: 10, max: 20}}), created_date: faker.date.past().toISOString().slice(0, 19) + 'Z', last_used: faker.date.past().toISOString().slice(0, 19) + 'Z', size: faker.number.int(), checksum: faker.string.alpha({length: {min: 10, max: 20}}), location: faker.string.alpha({length: {min: 10, max: 20}}), uri: faker.string.alpha({length: {min: 10, max: 20}}), metadata: {}, tags: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), collections: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}})))},{name: faker.string.alpha({length: {min: 10, max: 20}}), version: faker.string.alpha({length: {min: 10, max: 20}}), location: faker.string.alpha({length: {min: 10, max: 20}}), uri: faker.string.alpha({length: {min: 10, max: 20}}), hash_location: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), size: faker.number.int()},])))},{name: faker.string.alpha({length: {min: 10, max: 20}}), version: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.helpers.arrayElement(Object.values(DatasetStatus)), created_by: faker.string.alpha({length: {min: 10, max: 20}}), created_date: faker.date.past().toISOString().slice(0, 19) + 'Z', last_used: faker.date.past().toISOString().slice(0, 19) + 'Z', size: faker.number.int(), checksum: faker.string.alpha({length: {min: 10, max: 20}}), location: faker.string.alpha({length: {min: 10, max: 20}}), uri: faker.string.alpha({length: {min: 10, max: 20}}), metadata: {}, tags: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), collections: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}})))},]))), ...overrideResponse})

export const getUpdateCollectionApiBucketBucketDatasetNameRecollectPostResponseMock = (overrideResponse: Partial<Extract<DataUpdateResponse, object>> = {}): DataUpdateResponse => ({versions: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({dataset_name: faker.string.alpha({length: {min: 10, max: 20}}), version: faker.string.alpha({length: {min: 10, max: 20}})})), ...overrideResponse})

export const getGetNotificationSettingsApiProfileSettingsGetResponseMock = (overrideResponse: Partial<Extract<ProfileResponse, object>> = {}): ProfileResponse => ({profile: {username: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), email_notification: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.datatype.boolean(),null,]), undefined]), slack_notification: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.datatype.boolean(),null,]), undefined]), bucket: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), pool: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined])}, roles: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), pools: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), token: faker.helpers.arrayElement([faker.helpers.arrayElement([{name: faker.string.alpha({length: {min: 10, max: 20}}), expires_at: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined])},null,]), undefined]), ...overrideResponse})
...
export const getGetWorkflowPluginsConfigsApiPluginsConfigsGetResponseMock = (overrideResponse: Partial<Extract<PluginsConfigOutput, object>> = {}): PluginsConfigOutput => ({rsync: {enabled: faker.datatype.boolean(), enable_telemetry: faker.datatype.boolean(), read_bandwidth_limit: faker.number.int({min: 0}), write_bandwidth_limit: faker.number.int({min: 0}), allowed_paths: {
        [faker.string.alphanumeric(5)]: {path: faker.string.alpha({length: {min: 10, max: 20}}), writable: faker.datatype.boolean()}
...
export const getReadServiceConfigsApiConfigsServiceGetMockHandler = (overrideResponse?: ServiceConfigOutput | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<ServiceConfigOutput> | ServiceConfigOutput), options?: RequestHandlerOptions) => {
...
export const getReadWorkflowConfigsApiConfigsWorkflowGetMockHandler = (overrideResponse?: WorkflowConfigOutput | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<WorkflowConfigOutput> | WorkflowConfigOutput), options?: RequestHandlerOptions) => {
...
export const getReadDatasetConfigsApiConfigsDatasetGetMockHandler = (overrideResponse?: DatasetConfigOutput | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<DatasetConfigOutput> | DatasetConfigOutput), options?: RequestHandlerOptions) => {
...
export const getReadPoolApiConfigsPoolNameGetMockHandler = (overrideResponse?: PoolOutput | PoolEditable | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PoolOutput | PoolEditable> | PoolOutput | PoolEditable), options?: RequestHandlerOptions) => {
...
export const getReadPlatformInPoolApiConfigsPoolNamePlatformPlatformNameGetMockHandler = (overrideResponse?: PlatformMinimal | PlatformEditable | PlatformOutput | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PlatformMinimal | PlatformEditable | PlatformOutput> | PlatformMinimal | PlatformEditable | PlatformOutput), options?: RequestHandlerOptions) => {
...
export const getListRolesApiConfigsRoleGetMockHandler = (overrideResponse?: RoleOutput[] | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<RoleOutput[]> | RoleOutput[]), options?: RequestHandlerOptions) => {
...
export const getReadRoleApiConfigsRoleNameGetMockHandler = (overrideResponse?: RoleOutput | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<RoleOutput> | RoleOutput), options?: RequestHandlerOptions) => {
...
export const getUploadDatasetApiBucketBucketDatasetNamePostMockHandler = (overrideResponse?: DataUploadResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<DataUploadResponse> | DataUploadResponse), options?: RequestHandlerOptions) => {
  return http.post('*/api/bucket/:bucket/dataset/:name', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {await delay(0);
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getUploadDatasetApiBucketBucketDatasetNamePostResponseMock(),
      { status: 200
      })
  }, options)
}

export const getDownloadApiBucketBucketDatasetNameGetMockHandler = (overrideResponse?: DataDownloadResponse | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<DataDownloadResponse> | DataDownloadResponse), options?: RequestHandlerOptions) => {
  return http.get('*/api/bucket/:bucket/dataset/:name', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {await delay(0);
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getDownloadApiBucketBucketDatasetNameGetResponseMock(),
      { status: 200
      })
  }, options)
}
...
export const getMigrateDatasetApiBucketBucketDatasetNameMigratePostMockHandler = (overrideResponse?: DataDownloadResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<DataDownloadResponse> | DataDownloadResponse), options?: RequestHandlerOptions) => {
  return http.post('*/api/bucket/:bucket/dataset/:name/migrate', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {await delay(0);
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getMigrateDatasetApiBucketBucketDatasetNameMigratePostResponseMock(),
      { status: 200
      })
  }, options)
}
...
export const getGetManifestApiBucketBucketDatasetNameManifestGetMockHandler = (overrideResponse?: unknown[] | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<unknown[]> | unknown[]), options?: RequestHandlerOptions) => {
  return http.get('*/api/bucket/:bucket/dataset/:name/manifest', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {await delay(0);
  if (typeof overrideResponse === 'function') {await overrideResponse(info); }
...
export const getGetFileContentApiBucketBucketDatasetNameFileContentGetMockHandler = (overrideResponse?: unknown | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<unknown> | unknown), options?: RequestHandlerOptions) => {
  return http.get('*/api/bucket/:bucket/dataset/:name/file-content', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {await delay(0);
  if (typeof overrideResponse === 'function') {await overrideResponse(info); }
...
export const getGetFileContentApiBucketBucketDatasetNameFileContentGetHeadMockHandler = (overrideResponse?: unknown | ((info: Parameters<Parameters<typeof http.head>[1]>[0]) => Promise<unknown> | unknown), options?: RequestHandlerOptions) => {
  return http.head('*/api/bucket/:bucket/dataset/:name/file-content', async (info: Parameters<Parameters<typeof http.head>[1]>[0]) => {await delay(0);
  if (typeof overrideResponse === 'function') {await overrideResponse(info); }
...
export const getGetPathInformationApiBucketBucketLocationGetMockHandler = (overrideResponse?: unknown | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<unknown> | unknown), options?: RequestHandlerOptions) => {
  return http.get('*/api/bucket/:bucket/location', async (info: Parameters<Parameters<typeof http.get>[1]>[0]) => {await delay(0);
  if (typeof overrideResponse === 'function') {await overrideResponse(info); }
...
export const getUpdateCollectionApiBucketBucketDatasetNameRecollectPostMockHandler = (overrideResponse?: DataUpdateResponse | ((info: Parameters<Parameters<typeof http.post>[1]>[0]) => Promise<DataUpdateResponse> | DataUpdateResponse), options?: RequestHandlerOptions) => {
  return http.post('*/api/bucket/:bucket/dataset/:name/recollect', async (info: Parameters<Parameters<typeof http.post>[1]>[0]) => {await delay(0);
  
  
    return HttpResponse.json(overrideResponse !== undefined
    ? (typeof overrideResponse === "function" ? await overrideResponse(info) : overrideResponse)
    : getUpdateCollectionApiBucketBucketDatasetNameRecollectPostResponseMock(),
      { status: 200
      })
  }, options)
}
...
export const getGetWorkflowPluginsConfigsApiPluginsConfigsGetMockHandler = (overrideResponse?: PluginsConfigOutput | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<PluginsConfigOutput> | PluginsConfigOutput), options?: RequestHandlerOptions) => {
...
export const getFastAPIMock = () => [
  ...
  getUploadDatasetApiBucketBucketDatasetNamePostMockHandler(),
  getDownloadApiBucketBucketDatasetNameGetMockHandler(),
  getDeleteDatasetApiBucketBucketDatasetNameDeleteMockHandler(),
  getMigrateDatasetApiBucketBucketDatasetNameMigratePostMockHandler(),
  ...
  getGetManifestApiBucketBucketDatasetNameManifestGetMockHandler(),
  getGetFileContentApiBucketBucketDatasetNameFileContentGetMockHandler(),
  getGetFileContentApiBucketBucketDatasetNameFileContentGetHeadMockHandler(),
  ...
  getGetPathInformationApiBucketBucketLocationGetMockHandler(),
  getUpdateCollectionApiBucketBucketDatasetNameRecollectPostMockHandler(),
