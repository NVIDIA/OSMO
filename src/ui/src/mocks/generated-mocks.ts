 ...
 */
export type UserDataCredentialAddressingStyle =
  | (typeof UserDataCredentialAddressingStyle)[keyof typeof UserDataCredentialAddressingStyle]
  | null;
 ...
 * S3 request addressing style for S3-compatible providers. Use 'virtual' for providers such as CoreWeave CAIOS that reject path-style requests, or 'path' for localstack/MinIO-style endpoints.
 */
export type StaticDataCredentialAddressingStyle =
  | (typeof StaticDataCredentialAddressingStyle)[keyof typeof StaticDataCredentialAddressingStyle]
  | null;
 ...
 * S3 request addressing style for S3-compatible providers. Use 'virtual' for providers such as CoreWeave CAIOS that reject path-style requests, or 'path' for localstack/MinIO-style endpoints.
 */
export type DefaultDataCredentialAddressingStyle =
  | (typeof DefaultDataCredentialAddressingStyle)[keyof typeof DefaultDataCredentialAddressingStyle]
  | null;
...
export const getAppContentApiAppUserNameSpecGet = async (
  ...
  const data: getAppContentApiAppUserNameSpecGetResponse["data"] = body ? JSON.parse(body) : undefined;
...
export const getWorkflowLogsApiWorkflowNameLogsGet = async (
  ...
  const data: getWorkflowLogsApiWorkflowNameLogsGetResponse["data"] = body
...
export const getWorkflowPodConditionsApiWorkflowNameEventsGet = async (
  ...
  const data: getWorkflowPodConditionsApiWorkflowNameEventsGetResponse["data"] = body
    ? contentType.includes("json")
      ? JSON.parse(body)
      : body
    : {};
...
export const getWorkflowErrorLogsApiWorkflowNameErrorLogsGet = async (
  ...
  const data: getWorkflowErrorLogsApiWorkflowNameErrorLogsGetResponse["data"] = body
    ? contentType.includes("json")
      ? JSON.parse(body)
      : body
    : {};
...
export const getWorkflowSpecApiWorkflowNameSpecGet = async (
  ...
  const data: getWorkflowSpecApiWorkflowNameSpecGetResponse["data"] = body
    ? contentType.includes("json")
      ? JSON.parse(body)
      : body
    : {};
...
export const getGetConfigsHistoryApiConfigsHistoryGetResponseMock = (
  ...
  configs: Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
    config_type: faker.helpers.arrayElement(Object.values(ConfigHistoryType)),
    name: faker.string.alpha({ length: { min: 10, max: 20 } }),
