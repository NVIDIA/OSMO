...
export const getReadWorkflowConfigsApiConfigsWorkflowGetResponseMock = (overrideResponse: Partial<Extract<WorkflowConfigOutput, object>> = {}): WorkflowConfigOutput => ({workflow_data: {credential: faker.helpers.arrayElement([faker.helpers.arrayElement([{endpoint: faker.string.alpha({length: {min: 10, max: 20}}), region: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), override_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), access_key_id: faker.string.alpha({length: {min: 10, max: 20}}), access_key: faker.internet.password()},null,]), undefined]), base_url: faker.string.alpha({length: {min: 10, max: 20}}), websocket_timeout: faker.number.int(), data_timeout: faker.number.int(), download_type: faker.helpers.arrayElement(Object.values(DownloadType))}, workflow_log: {credential: faker.helpers.arrayElement([faker.helpers.arrayElement([{endpoint: faker.string.alpha({length: {min: 10, max: 20}}), region: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), override_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), access_key_id: faker.string.alpha({length: {min: 10, max: 20}}), access_key: faker.internet.password()},null,]), undefined])}, workflow_app: {credential: faker.helpers.arrayElement([faker.helpers.arrayElement([{endpoint: faker.string.alpha({length: {min: 10, max: 20}}), region: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), override_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), access_key_id: faker.string.alpha({length: {min: 10, max: 20}}), access_key: faker.internet.password()},null,]), undefined])}, workflow_info: {tags: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), max_name_length: faker.number.int()}, backend_images: {init: faker.string.alpha({length: {min: 10, max: 20}}), client: faker.string.alpha({length: {min: 10, max: 20}}), credential: {registry: faker.string.alpha({length: {min: 10, max: 20}}), username: faker.string.alpha({length: {min: 10, max: 20}}), auth: faker.internet.password()}}, workflow_alerts: {slack_token: faker.internet.password(), smtp_settings: {host: faker.string.alpha({length: {min: 10, max: 20}}), sender: faker.string.alpha({length: {min: 10, max: 20}}), password: faker.internet.password()}}, credential_config: {disable_registry_validation: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}}))), disable_data_validation: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => (faker.string.alpha({length: {min: 10, max: 20}})))}, user_workflow_limits: {max_num_workflows: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int({min: 0}),null,]), undefined]), max_num_tasks: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int({min: 0}),null,]), undefined]), jinja_sandbox_workers: faker.number.int(), jinja_sandbox_max_time: faker.number.float({fractionDigits: 2}), jinja_sandbox_memory_limit: faker.number.int()}, plugins_config: {rsync: {enabled: faker.datatype.boolean(), enable_telemetry: faker.datatype.boolean(), read_bandwidth_limit: faker.number.int({min: 0}), write_bandwidth_limit: faker.number.int({min: 0}), allowed_paths: {
...
export const getReadDatasetConfigsApiConfigsDatasetGetResponseMock = (overrideResponse: Partial<Extract<DatasetConfigOutput, object>> = {}): DatasetConfigOutput => ({buckets: {
        [faker.string.alphanumeric(5)]: {dataset_path: faker.helpers.fromRegExp('(^swift://[^/,;*]+(/[^/,;*]+){2,}/*$|^s3://[^/,;*]+(/[^/,;*]+)*/*$|^gs://[^/,;*]+(/[^/,;*]+)*/*$|^tos://[^/,;*]+(/[^/,;*]+)+/*$|^azure://[^/,;*]+(/[^/,;*]+)+/*$)'), region: faker.string.alpha({length: {min: 10, max: 20}}), description: 'A test resource', mode: faker.string.alpha({length: {min: 10, max: 20}}), default_credential: faker.helpers.arrayElement([faker.helpers.arrayElement([{endpoint: faker.string.alpha({length: {min: 10, max: 20}}), region: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), override_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), access_key_id: faker.string.alpha({length: {min: 10, max: 20}}), access_key: faker.internet.password()},null,]), undefined])}
...
export const getListWorkflowApiWorkflowGetResponseMock = (overrideResponse: Partial<Extract<SrcServiceCoreWorkflowObjectsListResponse, object>> = {}): SrcServiceCoreWorkflowObjectsListResponse => ({workflows: Array.from({ length: faker.number.int({min: 1, max: 10}) }, (_, i) => i + 1).map(() => ({user: faker.string.alpha({length: {min: 10, max: 20}}), name: faker.string.alpha({length: {min: 10, max: 20}}), workflow_uuid: faker.string.alpha({length: {min: 10, max: 20}}), submit_time: faker.date.past().toISOString().slice(0, 19) + 'Z', start_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), end_time: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z',null,]), undefined]), queued_time: faker.string.alpha({length: {min: 10, max: 20}}), duration: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), status: faker.helpers.arrayElement(Object.values(WorkflowStatus)), overview: faker.string.alpha({length: {min: 10, max: 20}}), logs: faker.string.alpha({length: {min: 10, max: 20}}), error_logs: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), grafana_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), dashboard_url: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), pool: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), app_owner: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), app_name: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}),null,]), undefined]), app_version: faker.helpers.arrayElement([faker.helpers.arrayElement([faker.number.int(),null,]), undefined]), priority: faker.string.alpha({length: {min: 10, max: 20}})})), more_entries: faker.datatype.boolean(), ...overrideResponse})
