...
def main():
    ...
    parser.add_argument('--output_dir',
                        required=True,
                        help='The output directory for the onedir tarball')
    ...
    add_data_args = []
    if args.add_data is not None:
        for add_data_arg in args.add_data:
            add_data_args.append(f'--add-data={os.path.join(runner_dir, add_data_arg)}')
