...
```
┌──────────────────────────────────────────────────────────────────────────────────────┐
│ [🔍 Search pools...]                                         [used ⟷ free] [compact] │
├──────────────────────────────────────────────────────────────────────────────────────┤
│ POOL ▴        │ DESCRIPTION      │ QUOTA (GPU) ▼ │ CAPACITY (GPU) │ PLATFORMS│BACKEND│
│              ↔│                 ↔│              ↔│               ↔│         ↔│      ↔│  ← Resize handles
╞══════════════════════════════════════════════════════════════════════════════════════╡
│ ⭐🟢 pool-dev │ Development      │ ██░░░░ 80 free│ ███░░░░ 120 idl│[arm64]+2 │ k8s   │  ← Default always first
├──────────────────────────────────────────────────────────────────────────────────────┤
│ ▼ 🟢 Online (3)                                                                       │  ← Collapsible section
├──────────────────────────────────────────────────────────────────────────────────────┤
│ pool-staging  │ Staging env      │ █████░ 50 free│ █████░░ 80 idle│[x86]+1   │ k8s   │
│ pool-prod     │ Production       │ ████████20 fre│ ███████ 20 idle│[arm][x86]│ k8s   │
│ pool-batch    │ Batch processing │ ██████████ 0  │ █████████ 10 🔗│[x86]+3   │ k8s   │  ← 🔗 = shared capacity
├──────────────────────────────────────────────────────────────────────────────────────┤
...
- **Always at top** of table (above all status sections)
- Shows `⭐` badge + actual status indicator (`🟢`/`🔧`/`🔴`)
- If default is Offline, still shows at top so user sees it immediately
...
export function PoolsTable({ pools, sharingGroups, defaultPoolName }: Props) {
  const {
    sorting, setSorting,
...
│ ⭐ Your Default Pool                                            │
│ ┌─────────────────────────────────────────────────────────────┐ │
│ │ pool-dev    Development    ████░░ 8/12 GPU    4 available   │ │
│ └─────────────────────────────────────────────────────────────┘ │
├─────────────────────────────────────────────────────────────────┤
│ ▼ 🟢 Online (5)                                                 │
│ ┌─────────────────────────────────────────────────────────────┐ │
