        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-amber-300/70">
              Position #3 in queue • Estimated wait: ~30 minutes
            </p>
          </div>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="p-4 rounded-lg bg-zinc-800/50 space-y-3">
            ...
            <div className="w-full h-2 rounded-full bg-zinc-700 overflow-hidden">
              <div className="h-full bg-red-500" style={{ width: "87.5%" }} />
            </div>
            <div className="text-xs text-zinc-500">
              87.5% utilized • 2 workflows ahead of you
            </div>
          </div>
        </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-zinc-400 mt-0.5">
                    gpu-pool-us-west has 6 GPUs available
                  </div>
                </div>
            ...
            <button className="w-full p-3 rounded-lg bg-zinc-800/50 hover:bg-zinc-800 border border-zinc-700/50 hover:border-zinc-600 transition-all text-left group">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-zinc-400 mt-0.5">
                    Will schedule before NORMAL/LOW priority workflows
                  </div>
                </div>
                <ArrowRight className="h-4 w-4 text-zinc-500 group-hover:text-zinc-300 transition-colors" />
              </div>
            ...
            <button className="w-full p-3 rounded-lg bg-zinc-800/50 hover:bg-zinc-800 border border-zinc-700/50 hover:border-zinc-600 transition-all text-left group">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-xs text-zinc-400 mt-0.5">
                    2 GPUs available now - modify workflow spec
                  </div>
                </div>
                <ArrowRight className="h-4 w-4 text-zinc-500 group-hover:text-zinc-300 transition-colors" />
              </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex items-start gap-2 text-zinc-400">
              ...
              <span>
                <strong className="text-zinc-200">Missing registry credentials</strong> - 
                You need to add NGC credentials to access nvcr.io images
              </span>
            </li>
            <li className="flex items-start gap-2 text-zinc-400">
              <span className="text-red-400 mt-0.5">2.</span>
              <span>
                <strong className="text-zinc-200">Image doesn&apos;t exist</strong> - 
                The tag &quot;24.03-custom&quot; may not exist in the registry
              </span>
            </li>
            <li className="flex items-start gap-2 text-zinc-400">
              <span className="text-red-400 mt-0.5">3.</span>
              <span>
                <strong className="text-zinc-200">Expired credentials</strong> - 
                Your NGC API key may have expired
              </span>
            </li>
          </ul>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 rounded-lg bg-zinc-800/50 border border-zinc-700/50">
              ...
              <p className="text-sm text-zinc-400 mb-3">
                Add your NGC API key to authenticate with nvcr.io
              </p>
            ...
            <div className="p-4 rounded-lg bg-zinc-800/50 border border-zinc-700/50">
              ...
              <p className="text-sm text-zinc-400 mb-3">
                After fixing credentials, restart with the same spec
              </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-zinc-400">
                  Ran on gpu-node-02 • 1 GPU, 32Gi memory
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <button className="w-full p-3 rounded-lg bg-zinc-800/50 hover:bg-zinc-800 border border-zinc-700/50 hover:border-zinc-600 transition-all text-left group">
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium text-zinc-200 text-sm">
                    Increase exec_timeout
                  </div>
                  <div className="text-xs text-zinc-400 mt-0.5">
                    Set timeout.exec_timeout: 4h in your workflow spec
                  </div>
                </div>
                <ArrowRight className="h-4 w-4 text-zinc-500 group-hover:text-zinc-300 transition-colors" />
              </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-400">
            Your workflow was submitted with <span className="text-blue-400 font-medium">LOW priority</span>. 
            When a <span className="text-red-400 font-medium">HIGH</span> or{" "}
            <span className="text-zinc-300 font-medium">NORMAL</span> priority workflow 
            needed the GPUs you were using, your workflow was preempted to free up resources.
          </p>
        </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3 p-3 rounded-lg bg-red-500/10 border border-red-500/20">
              ...
              <span className="text-sm text-zinc-300">
                Scheduled first, never preempted, counts against quota
              </span>
            </div>
            <div className="flex items-center gap-3 p-3 rounded-lg bg-zinc-500/10 border border-zinc-500/20">
              ...
              <span className="text-sm text-zinc-300">
                Scheduled after HIGH, never preempted, counts against quota
              </span>
            </div>
...
export default function ExplainMockPage() {
  const [activeScenario, setActiveScenario] = useState<
    "queued" | "image_pull" | "timeout" | "preempted"
  >("queued");
    ...
    <div className="max-w-3xl mx-auto py-8 px-4 space-y-8">
      ...
      <div className="p-6 rounded-lg border border-dashed border-zinc-700 bg-zinc-900/30">
        ...
        <ul className="space-y-2 text-sm text-zinc-400">
          <li>
            ✅ <strong>Answer first</strong>: Lead with the status and a clear
            explanation
          </li>
          <li>
            ✅ <strong>Show context</strong>: Display relevant data (resources,
            pool status, timing)
          </li>
          <li>
            ✅ <strong>Actionable suggestions</strong>: Every explainer ends with
            concrete next steps
          </li>
          <li>
            ✅ <strong>Visual hierarchy</strong>: Color coding (amber=queued,
            red=failed, orange=warning)
          </li>
          <li>
            ✅ <strong>Progressive disclosure</strong>: Essential info first,
          ...
          <li>
            ✅ <strong>Deep links</strong>: Buttons navigate to related pages
            (credentials, pools, docs)
          </li>
        </ul>
      </div>
    </div>
