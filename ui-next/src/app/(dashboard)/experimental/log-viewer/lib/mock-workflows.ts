...
export const MOCK_WORKFLOWS: Record<string, WorkflowQueryResponse> = {
  "mock-workflow-1": {
    ...
    spec_url: "/api/workflow/mock-workflow-1/spec",
    logs_url: "/api/workflow/mock-workflow-1/logs",
    events_url: "/api/workflow/mock-workflow-1/events",
  },
  ...
  "mock-workflow-2": {
    ...
    image: "nvcr.io/nvidia/pytorch:24.01-py3",
    spec_url: "/api/workflow/mock-workflow-2/spec",
    logs_url: "/api/workflow/mock-workflow-2/logs",
    events_url: "/api/workflow/mock-workflow-2/events",
  },
  ...
  "mock-workflow-3": {
    ...
    submitted_by: "user@example.com",
    status: WorkflowStatus.FAILED_RETRIES_EXCEEDED,
    priority: WorkflowPriority.NORMAL,
    pool: "default",
    backend: "kubernetes",
    ...
    groups: [
      ...
      {
        name: "train",
        status: TaskGroupStatus.FAILED_RETRIES_EXCEEDED,
        upstream_groups: ["data_load"],
        downstream_groups: [],
    ...
    image: "nvcr.io/nvidia/pytorch:24.01-py3",
    spec_url: "/api/workflow/mock-workflow-3/spec",
    logs_url: "/api/workflow/mock-workflow-3/logs",
    events_url: "/api/workflow/mock-workflow-3/events",
  },
};
