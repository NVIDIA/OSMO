...
import { transformGroups as _transformGroups } from "./adapters";
...
// Re-export canonical implementations from utils/status
// This avoids duplication while maintaining backwards compatibility
export { isFailedStatus, getStatusCategory } from "./utils/status";
