  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "text-sidebar-foreground flex h-full w-(--sidebar-width) flex-col bg-white dark:bg-zinc-950",
          className,
        )}
        {...props}
      >
    ...
    return (
      ...
      >
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="text-sidebar-foreground w-(--sidebar-width) bg-white p-0 dark:bg-zinc-950 [&>button]:hidden"
          style={
            {
    ...
    >
      ...
      >
        <div
          ...
          className="group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col bg-white group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm dark:bg-zinc-950"
        >
          {children}
        </div>
      </div>
...
function SidebarInset({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "bg-background relative flex min-w-0 flex-1 flex-col overflow-x-visible overflow-y-hidden",
