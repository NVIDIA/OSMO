 ...
 *
 * Toolbar for the shell with shell selector and actions.
 */
...
export const ShellToolbar = memo(function ShellToolbar({
  ...
  return (
    <div className={cn("shell-status flex items-center justify-between", className)}>
      <div className="shell-status-left flex items-center gap-3">
        {/* Shell Selector */}
        <DropdownMenu
          open={isOpen}
      ...
      <div className="shell-status-right flex items-center gap-1">
        {/* Search Toggle */}
        {onToggleSearch && (
          <Button
            variant="ghost"
