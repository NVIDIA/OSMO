...
import { computeTaskStats, computeGroupStatus, computeGroupDuration } from "@/features/workflows/detail/lib/status";
import type { GroupDetailsProps } from "@/features/workflows/detail/lib/panel-types";
import type { TaskWithDuration } from "@/features/workflows/detail/lib/workflow-types";
import { DetailsPanelHeader } from "@/features/workflows/detail/components/panel/views/details-panel-header";
import { useTick } from "@/hooks/use-tick";
import type { BreadcrumbSegment } from "@/features/workflows/detail/lib/panel-types";
import { GroupOverviewTab } from "@/features/workflows/detail/components/panel/group/group-overview-tab";
import { GroupTasksTab } from "@/features/workflows/detail/components/panel/group/group-tasks-tab";
import type { GroupTab } from "@/features/workflows/detail/hooks/use-navigation-state";
