...
import { usePanelResize } from "@/features/workflows/detail/lib/panel-resize-context";
import { ACTIVITY_STRIP_WIDTH_PX } from "@/features/workflows/detail/lib/panel-constants";
import {
  WorkflowEdgeStrip,
  type QuickAction,
} from "@/features/workflows/detail/components/panel/workflow/workflow-edge-strip";

// Eager imports - panel views are always needed, dynamic imports add 100-300ms flash
import { WorkflowDetails } from "@/features/workflows/detail/components/panel/workflow/workflow-details";
import { GroupDetails } from "@/features/workflows/detail/components/panel/group/group-details";
import { TaskDetails } from "@/features/workflows/detail/components/panel/task/task-details";
import { ContentSlideWrapper } from "@/features/workflows/detail/components/panel/views/content-slide-wrapper";
