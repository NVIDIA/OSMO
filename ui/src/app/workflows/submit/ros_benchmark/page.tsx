...
import { ROS_BENCHMARK_WORKFLOW_FILE } from "~/models/workflows-model";
  ...
  return (
    <>
      <GenericHeader
        ...
        tailSegment={["submit", "ros_benchmark"]}
      />
      <WorkflowsSubmit placeholderFile={ROS_BENCHMARK_WORKFLOW_FILE} />
    </>
  );
}
