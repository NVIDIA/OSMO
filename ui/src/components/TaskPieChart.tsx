...
import { type TaskStatusType, TaskStatusValues } from "~/models/workflows-model";

interface TaskPieChartProps {
  counts: Partial<Record<TaskStatusType, number>>;
  size?: number;
  innerRadius?: number;
  className?: string;
  ariaLabel?: string;
  ...
  const slices: PieSlice[] = useMemo(
    () =>
      TaskStatusValues.map((status) => ({
        ...
        borderColor: getTaskStatusColor(status).borderColor,
