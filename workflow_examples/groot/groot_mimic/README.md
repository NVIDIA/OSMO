...
# NVIDIA OSMO - Running Groot Mimic through Isaac Lab Imitation Learning
...
```bash
curl -O https://raw.githubusercontent.com/NVIDIA/OSMO/main/workflow_examples/groot/groot_mimic/groot_mimic.yaml
osmo workflow submit ~/workflow_specs/groot_mimic.yaml
```
