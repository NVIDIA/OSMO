...
```bash
curl -O https://raw.githubusercontent.com/NVIDIA/OSMO/main/workflow_examples/integration_and_tools/vscode/vscode.yaml
...
osmo workflow port-forward <workflow-id> webserver --port 9000:9000
```
