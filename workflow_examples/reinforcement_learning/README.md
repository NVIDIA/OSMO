...
# NVIDIA OSMO - Training Robot Policy through Reinforcement Learning using Isaac Lab
...
```bash
curl -O https://raw.githubusercontent.com/NVIDIA/OSMO/main/workflow_examples/reinforcement_learning/train_policy.yaml
