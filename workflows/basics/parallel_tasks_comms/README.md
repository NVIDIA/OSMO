...
# Communicating between Parallel Tasks
...
```bash
curl -O https://raw.githubusercontent.com/NVIDIA/OSMO/main/workflows/basics/parallel_tasks_comms/parallel_tasks_comms.yaml
