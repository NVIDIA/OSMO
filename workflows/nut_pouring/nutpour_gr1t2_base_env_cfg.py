...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        robot_pov_cam_depth = ObsTerm(
            func=mdp.image,
            params={"sensor_cfg": SceneEntityCfg("robot_pov_cam"), 
                    "data_type": "distance_to_image_plane",
                    "normalize": True,"normalize": False},
        )

        robot_pov_cam_segmentation = ObsTerm(
            func=mdp.image,
            params={"sensor_cfg": SceneEntityCfg("robot_pov_cam"), "data_type": "semantic_segmentation", "normalize": True},
        )
        robot_pov_cam_normals = ObsTerm(
            func=mdp.image,
            params={"sensor_cfg": SceneEntityCfg("robot_pov_cam"), "data_type": "normals", "normalize": True},
        )
